...
const Foam::volScalarField& Foam::multiphaseMixture::Cp() const
{
    NotImplemented;
}


Foam::tmp<Foam::volScalarField> Foam::multiphaseMixture::lambda() const
{
    NotImplemented;
}

Foam::tmp<Foam::volScalarField> Foam::multiphaseMixture::Prt() const
{
    NotImplemented;
}

Foam::tmp<Foam::volScalarField> Foam::multiphaseMixture::Pr() const
{
    NotImplemented;
}

Foam::tmp<Foam::volScalarField> Foam::multiphaseMixture::alphaLam() const
{
    NotImplemented;
}
...
)
{
    ...
    forAllIter(PtrDictionary<phase>, phases_, iter)
    {
        phase& alpha = iter();
        alpha.ref() =
            alpha.internalField()/sumAlpha.internalField();
    }
...
bool Foam::multiphaseMixture::read()
{
    if (transportModel::read())
    {
        ...
        sigmas_ = lookup<sigmaTable>("sigmas");
