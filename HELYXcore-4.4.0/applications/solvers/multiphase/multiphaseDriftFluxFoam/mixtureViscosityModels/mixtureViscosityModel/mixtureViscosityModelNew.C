...
)
{
    ...
    auto ctor = ctorTableLookup("mixtureViscosityModel type", dictionaryConstructorTable_(), modelType);
    return autoPtr<mixtureViscosityModel>(ctor(name, viscosityProperties, U, phi));
}
