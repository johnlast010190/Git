...
:
    ...
    nu_("nu", dimensionSet(0, 2, -1, 0, 0), phaseDict_),
    kappa_("kappa", dimensionSet(1, 1, -3, -1, 0), phaseDict_),
    Cp_("Cp", dimensionSet(0, 2, -2, -1, 0), phaseDict_),
...
{
    phaseDict_ = phaseDict;
    nu_.value() = phaseDict_.lookup<scalar>("nu");
    kappa_.value() = phaseDict_.lookup<scalar>("kappa");
    Cp_.value() = phaseDict_.lookup<scalar>("Cp");
    rho_.value() = phaseDict_.lookup<scalar>("rho");
