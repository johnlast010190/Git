...
#include "../phaseSystems/interfacialModels/dragModels/dragModel/dragModel.H"
#include "../phaseSystems/interfacialModels/virtualMassModels/virtualMassModel/virtualMassModel.H"
#include "../phaseSystems/interfacialModels/liftModels/liftModel/liftModel.H"
#include "../phaseSystems/interfacialModels/wallLubricationModels/wallLubricationModel/wallLubricationModel.H"
#include "../phaseSystems/interfacialModels/turbulentDispersionModels/turbulentDispersionModel/turbulentDispersionModel.H"
    ...
    else
    {
        ...
        (
            ...
            (
                ...
                this->mesh_,
                dimensionedScalar(liftModel::dimF*dimArea, 0)
            )
        );
    ...
    else
    {
        ...
        (
            ...
            (
                ...
                this->mesh_,
                dimensionedScalar(turbulentDispersionModel::dimD, 0)
            )
        );
    }
}
    ...
    )
    {
        ...
        forAllConstIter(phasePair, pair, iter)
        {
            ...
            *eqns[phase->name()] -=
              ...
              + this->fvOptions_.MRFDDt(Vm, U - otherPhase->U());
