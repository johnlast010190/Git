...
#include "interfacialCompositionModels/saturationModels/saturationModel/saturationModel.H"
...
void alphatWallBoilingWallFunctionFvPatchScalarField::updateCoeffs()
{
    ...
    switch (phaseType_)
    {
        ...
        case liquidPhase:
        {
            ...
            const scalarField L
            (
                vapor.thermo().he(Tsatc, patchi) - hew.patchInternalField()
            );
...
(
    ...
    compressible__alphatWallBoilingWallFunction
);
