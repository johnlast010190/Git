...
)
{
    ...
    const auto ctor = ctorTableLookup("granularPressureModelType", dictionaryConstructorTable_(), granularPressureModelType);
    return autoPtr<granularPressureModel>(ctor(dict));
}
