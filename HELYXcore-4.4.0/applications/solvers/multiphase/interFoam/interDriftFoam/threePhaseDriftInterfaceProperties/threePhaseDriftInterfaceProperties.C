...
#include "threePhaseDriftInterfaceProperties.H"
...
const Foam::scalar Foam::threePhaseDriftInterfaceProperties::convertToRad =
    Foam::constant::mathematical::pi/180.0;


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

void Foam::threePhaseDriftInterfaceProperties::correctContactAngle
(
...
void Foam::threePhaseDriftInterfaceProperties::calculateK()
{
...
Foam::threePhaseDriftInterfaceProperties::threePhaseDriftInterfaceProperties
(
    const incompressibleThreePhaseDriftMixture& mixture
)
:
    mixture_(mixture),
    cAlpha_
...
Foam::threePhaseDriftInterfaceProperties::surfaceTensionForce() const
{
...
Foam::threePhaseDriftInterfaceProperties::nearInterface() const
{
    return max
    (
