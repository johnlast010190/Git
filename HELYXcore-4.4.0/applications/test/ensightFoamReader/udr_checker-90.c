  ...
  if ( Num_toggles > 0 || Num_pulldowns > 0 || Num_fields > 0 ) {
    ...
    *any_extra_gui = TRUE;
    ...
    if (Num_toggles>0) {
      ...
      if (Toggle_title == (char **)nullptr) return(Z_ERR);
      for (i=0; i<Num_toggles; i++) {
        Toggle_title[i] = (char *) calloc(Z_LEN_GUI_TITLE_STR,sizeof(char));
        if ( Toggle_title[i] == (char *)nullptr ) return(Z_ERR);
      }
    ...
    if (Num_fields > 0) {
      ...
      if (Field_title == (char **) nullptr) return(Z_ERR);
      for (i=0; i<Num_fields; i++) {
        Field_title[i] = (char *) calloc(Z_LEN_GUI_TITLE_STR,sizeof(char));
        if ( Field_title[i] == (char *)nullptr) return(Z_ERR);
        Field_user_string[i] = (char *) calloc(Z_LEN_GUI_FIELD_STR,sizeof(char));
        if ( Field_user_string[i] == (char *)nullptr) return(Z_ERR);
      }
    }
  ...
  if ( Num_ve_toggles > 0 || Num_ve_pulldowns > 0 || Num_ve_fields > 0 ) {
    ...
    *any_var_extract = TRUE;
    ...
    if (Num_ve_toggles > 0) {
      ...
      if (Toggle_ve_title == (char **)nullptr) return(Z_ERR);
      for (i=0; i<Num_ve_toggles; i++) {
        Toggle_ve_title[i] = (char *) calloc(Z_LEN_GUI_TITLE_STR,sizeof(char));
        if ( Toggle_ve_title[i] == (char *)nullptr ) return(Z_ERR);
      }
...
part_build_info(int geom_time_step)
{
  ...
  if(num_dataset_files > 0) {
    ...
    if(qfiles == (Z_QFILES *)nullptr) {
      ...
      for(i=0; i<num_dataset_files; ++i) {
        ...
        if(qfiles[i].f_desc == (char **)nullptr) {
          ...
          for(j=0; j<10; ++j) {
            ...
            if(qfiles[i].f_desc[j] == (char *)nullptr) {
              fprintf(stderr,"Error: allocating for dataset query descrip lines\n");
              return(Z_ERR);
            }
          }
  ...
  if(part_descriptions == (char **)nullptr) {
    ...
    for(i=0; i<Num_parts; ++i) {
      ...
      if(part_descriptions[i] == (char *)nullptr) {
        fprintf(stderr," Problems allocating for part descriptions\n");
        return(Z_ERR);
      }
    }
  ...
  if(ijk_dimensions == (int **)nullptr) {
    ...
    for(i=0; i<Num_parts; ++i) {
      ...
      if(ijk_dimensions[i] == (int *)nullptr) {
        fprintf(stderr," Problems allocating for part ijk dimensions\n");
        return(Z_ERR);
      }
      else {
  ...
  if(iblanking_options == (int **)nullptr) {
    ...
    for(i=0; i<Num_parts; ++i) {
      ...
      if(iblanking_options[i] == (int *)nullptr) {
        fprintf(stderr," Problems allocating for part iblanking options\n");
        return(Z_ERR);
      }
    }
  ...
  if(max_num_elems == (int **)nullptr) {
    ...
    for(i=0; i<Num_parts; ++i) {
      ...
      if(max_num_elems[i] == (int *)nullptr) {
  ...
  if(max_ijk_dimensions == (int **)nullptr) {
    ...
    for(i=0; i<Num_parts; ++i) {
      ...
      if(max_ijk_dimensions[i] == (int *)nullptr) {
        fprintf(stderr," Problems allocating for part max ijk dimensions\n");
        return(Z_ERR);
      }
    }
...
variable_info( void )
{
  ...
  if(var_description == (char **)nullptr) {
    ...
    for(i=0; i<Num_vars; ++i) {
      ...
      if(var_description[i] == (char *)nullptr) {
        fprintf(stderr," Problems allocating for var description\n");
        return(Z_ERR);
      }
    }
  ...
  if(var_filename == (char **)nullptr) {
    ...
    for(i=0; i<Num_vars; ++i) {
      ...
      if(var_filename[i] == (char *)nullptr) {
        fprintf(stderr," Problems allocating for var filename\n");
        return(Z_ERR);
      }
    }
  ...
  if(var_ifilename == (char **)nullptr) {
    ...
    for(i=0; i<Num_vars; ++i) {
      ...
      if(var_ifilename[i] == (char *)nullptr) {
        fprintf(stderr," Problems allocating for var ifilename\n");
        return(Z_ERR);
      }
    }
