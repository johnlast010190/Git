...
Copyright
    ...
    (c) 2014-2018 OpenFOAM Foundation
...
int main(int argc, char *argv[])
{
    ...
    argList::addBoolOption("overwrite", "Overwrite input surface");
    ...
    forAll(surfs, surfI)
    {
        ...
        word name = "hookedSurface_" + surfs.names()[surfI];
        if (overwrite)
        {
            name = surfs.names()[surfI];
        }
