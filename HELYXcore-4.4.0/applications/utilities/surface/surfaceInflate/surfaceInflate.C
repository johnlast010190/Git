...
)
{
    ...
    tmp<pointField> tpoints(s.points());
...
int main(int argc, char *argv[])
{
    ...
    tmp<pointField> tinitialPoints(s.points());
    const pointField& initialPoints = tinitialPoints;
    ...
    (
        ...
        s,
        dimLength,
        vectorField(distance*scale*pointNormals)
    );
