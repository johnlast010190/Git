...
int main(int argc, char *argv[])
{
    ...
    Info<< "Read " << returnReduceToMaster(cellsToRefine.size(), sumOp<label>())
    ...
    Info<< "Refined from " << returnReduceToMaster(map().nOldCells(), sumOp<label>())
