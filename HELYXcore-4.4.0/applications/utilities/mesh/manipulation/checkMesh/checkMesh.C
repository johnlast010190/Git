...
int main(int argc, char *argv[])
{
    ...
    (
        "minFaceArea",
        "scalar",
        "Minimum to be used in face area check"
    );
    ...
    const scalar minFaceArea =
        args.optionLookupOrDefault("minFaceArea", VSMALL);
    ...
    forAll(regionNames, regionI)
    {
        ...
        else
        {
            ...
            if (helyxHeader.typeHeaderOk<IOdictionary>(true))
            {
                IOdictionary helyxDict
                (
                    IOobject
                    (
                        "helyxHexMeshDict",
                ...
                const dictionary& qualityDict =
                    helyxDict.subDict("meshQualityControls");
                qualDict.reset
                (
                    new IOdictionary
                    (
        ...
        forAll(metrics, metricI)
        {
            ...
            if (metricName == "nonOrthogonality")
            {
                ...
                {
                    scalar maxOrtho =
                        qualDict().lookup<scalar>("maxNonOrtho");
            ...
            else if (metricName == "skewness")
            {
                ...
                {
                    scalar maxBoundSkew =
                        qualDict().lookup<scalar>("maxBoundarySkewness");
                    if (maxBoundSkew < 0)
                    {
                ...
                {
                    scalar maxIntSkew =
                        qualDict().lookup<scalar>("maxInternalSkewness");
                    if (maxIntSkew < 0)
                    {
            ...
            else if (metricName == "weights")
            {
                ...
                else
                {
                    scalar minFaceWeight =
                        qualDict().lookup<scalar>("minFaceWeight");
                    if (minFaceWeight < 0)
                    {
            ...
            else if (metricName == "volumeRatio")
            {
                ...
                {
                    scalar minVolRatio =
                        qualDict().lookup<scalar>("minVolRatio");
                    if (minVolRatio < 0)
                    {
            ...
            else if (metricName == "determinant")
            {
                ...
                {
                    scalar minDet =
                        qualDict().lookup<scalar>("minDeterminant");
                    if (minDet < 0)
                    {
            ...
            else if (metricName == "warpage")
            {
                ...
                {
                    scalar intWarp =
                        qualDict().lookup<scalar>("maxInternalWarpage");
                    if (intWarp <= 0)
                    {
                ...
                {
                    scalar boundWarp =
                        qualDict().lookup<scalar>("maxBoundaryWarpage");
                    if (boundWarp <= 0)
                    {
            ...
            else if (metricName == "aspectRatio")
            {
                ...
                {
                    scalar maxAR =
                        qualDict().lookup<scalar>("maxCellAspectRatio");
                    if (maxAR < 0)
                    {
