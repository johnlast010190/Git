...
#include "include/createTime.H"
    ...
    forAll(regionNames, regionI)
    {
        ...
        forAll(transformDicts, dictI)
        {
            ...
            scalar initL = tDict.lookup<scalar>("initialLength");
            scalar finL = tDict.lookup<scalar>("stretchLength");
            scalar xr = tDict.lookup<scalar>("expansionRatio");
            if (xr <= 1)
            {
            ...
            scalar rlnr = 1/Foam::log(xr);
            scalar delta = tDict.lookup<scalar>("delta");
            ...
            scalar maxXf2 = (Foam::pow(xr, Xi2) - 1)*rlnr;
            if (maxXf2 < Xf2)
            {
            ...
            scalar Xi1 = 1;
            {
                ...
                do
                {
                    ...
                    Xi1 = rlnr*Foam::log((Xf2+rlnr)/(rlnr+Xi2-Xi1));
            ...
            scalar xrPowXi1 = Foam::pow(xr, Xi1);
