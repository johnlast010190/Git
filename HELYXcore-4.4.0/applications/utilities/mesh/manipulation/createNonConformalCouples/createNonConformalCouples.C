...
Note
    ...
    system/nonConformalCouplesDict dictionary (or from a different
...
int main(int argc, char *argv[])
{
    ...
    for (label patchi = 0; patchi < firstProcPatchi; ++ patchi)
    {
        ...
        newPatchFieldDicts.append(dictionary());
    }
    ...
    forAll(patchNames, i)
    {
        ...
        newPatchFieldDicts.append(patchFieldDicts[i][0]);
        ...
        newPatchFieldDicts.append(patchFieldDicts[i][1]);
    }
