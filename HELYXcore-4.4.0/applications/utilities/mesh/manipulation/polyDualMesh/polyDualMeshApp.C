...
#include "meshDualiser/meshDualiser.H"
...
int main(int argc, char *argv[])
{
    ...
    forAll(regionNames, regionI)
    {
        ...
        // Edge(centre)s  ,,
        labelList featureEdges;
        // Points (that become a single cell) that need
        // inclusion in the dual mesh
        labelList singleCellFeaturePoints;
        ...
        // Insert all commands into polyTopoChange to create dual of mesh.
