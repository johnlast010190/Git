    ...
    forAll(patchHeatFlux, patchi)
    {
        if (isA<wallFvPatch>(mesh.boundary()[patchi]))
        {
            ...
            Info<< mesh.boundary()[patchi].name() << nl
                << "  convective heat rate [W]: " << convFlux << nl
                << "  radiative  heat rate [W]: " << radFlux << nl
                << "  total heat rate      [W]: " << convFlux + radFlux << nl
...
)
{
    ...
    autoPtr<fluidThermo> thermo(fluidThermo::New(mesh).ptr());
        ...
        if (Qr.typeHeaderOk<volScalarField>(true))
        {
            ...
            (
                ...
                (
                    ...
                    mesh,
                    dimensionedScalar(wallHeatFlux.dimensions(), 0)
                )
            );
        }
        ...
        if (Qr.typeHeaderOk<volScalarField>(true))
        {
            ...
            (
                ...
                (
                    ...
                    mesh,
                    dimensionedScalar(wallHTCconv.dimensions(), 0)
                )
            );
        }
        ...
        if (Qr.typeHeaderOk<volScalarField>(true))
        {
            ...
            (
                ...
                (
                    ...
                    mesh,
                    dimensionedScalar(wallNusselt.dimensions(), 0)
                )
            );
        }
