...
defineTypeNameAndDebug(pimpleFoamRASState, 0);
addToRunTimeSelectionTable(stateFunction, pimpleFoamRASState, dictionary);
...
pimpleFoamRASState::pimpleFoamRASState
(
    word region,
