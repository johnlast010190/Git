...
#include "rhoPimpleFoamRASState.H"
...
defineTypeNameAndDebug(rhoPimpleFoamRASState, 0);
addToRunTimeSelectionTable(stateFunction, rhoPimpleFoamRASState, dictionary);
...
rhoPimpleFoamRASState::rhoPimpleFoamRASState
(
    word region,
