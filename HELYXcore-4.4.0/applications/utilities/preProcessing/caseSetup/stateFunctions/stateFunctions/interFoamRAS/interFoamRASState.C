...
defineTypeNameAndDebug(interFoamRASState, 0);
addToRunTimeSelectionTable(stateFunction, interFoamRASState, dictionary);
...
interFoamRASState::interFoamRASState
(
    word region,
...
void interFoamRASState::finalise()
{
