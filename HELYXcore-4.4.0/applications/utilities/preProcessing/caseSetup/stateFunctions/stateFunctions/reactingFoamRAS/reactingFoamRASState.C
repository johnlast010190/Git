...
#include "reactingFoamRASState.H"
...
defineTypeNameAndDebug(reactingFoamRASState, 0);
addToRunTimeSelectionTable(stateFunction, reactingFoamRASState, dictionary);
...
reactingFoamRASState::reactingFoamRASState
(
    word region,
...
void reactingFoamRASState::finalise()
{
