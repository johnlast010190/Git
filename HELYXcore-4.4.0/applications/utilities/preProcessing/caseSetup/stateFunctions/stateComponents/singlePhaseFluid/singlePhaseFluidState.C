...
dictionary singlePhaseFluidState::incompressibleProperties
(
    const word& matName,
...
dictionary singlePhaseFluidState::compressibleProperties
(
    const word& matName,
    const dictionary& materialProperties
)
...
dictionary singlePhaseFluidState::setupMaterialProperties
(
    const word& matName,
    const dictionary& materialProperties
)
