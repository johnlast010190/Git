...
int main(int argc, char *argv[])
{
    ...
    WarningInFunction << nl
        ...
        << "is now superseded by helyxMap." << nl
        << "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
        << "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~" << endl;
    ...
    forAll(sourceRegions, regioni)
    {
        ...
        if (!consistent)
        {
            patchMap = mapFieldsDict.lookup<HashTable<word>>("patchMap");
            cuttingPatches = mapFieldsDict.lookup<wordList>("cuttingPatches");
        }
