...
#include "plugins/PatchValuePluginFunction.H"
...
vexp:   vector                  { $$ = $1; }
        ...
        | TOKEN_Cn '(' ')'              {
            $$ = driver.makeCellNeighbourField().ptr();
          }
        | TOKEN_delta '(' ')'              {
...
sreduced: TOKEN_min '(' exp ')'       { $$ = Foam::gMin(*$3);
            delete $3;
          }
        | TOKEN_max '(' exp ')'       { $$ = Foam::gMax(*$3);
            delete $3;
          }
        | TOKEN_min '(' pexp ')'      { $$ = Foam::gMin(*$3);
            delete $3;
          }
        | TOKEN_max '(' pexp ')'      { $$ = Foam::gMax(*$3);
            delete $3;
          }
        | TOKEN_sum '(' exp ')'       { $$ = Foam::gSum(*$3);
            delete $3;
          }
        | TOKEN_sum '(' pexp ')'      { $$ = Foam::gSum(*$3);
            delete $3;
          }
        | TOKEN_average '(' exp ')'   { $$ = Foam::gAverage(*$3);
            delete $3;
          }
        | TOKEN_average '(' pexp ')'  { $$ = Foam::gAverage(*$3);
            delete $3;
          }
;
...
// produces a reduce/reduce-conflict with the rule below
	...
	| '(' exp ')'		{ $$ = $2; }
        ...
        | TOKEN_pos '(' exp ')'           {
            $$ = new Foam::scalarField(Foam::pos0(*$3));
            delete $3;
          }
        | TOKEN_neg '(' exp ')'           {
...
pyexp:  psymmTensor     { $$ = $1; }
	...
	| TOKEN_oldTime '(' TOKEN_PYID ')'		{
            $$=driver.getOldTimeField<Foam::symmTensor>(*$3).ptr();delete $3;
          }
...
pvector: TOKEN_VECTOR '(' pexp ',' pexp ',' pexp ')' {
            $$ = driver.composeVectorField(*$3,*$5,*$7).ptr();
            delete $3; delete $5; delete $7;
          }
;

ptensor: TOKEN_TENSOR '(' pexp ',' pexp ',' pexp ',' pexp ',' pexp ',' pexp ',' pexp ',' pexp ',' pexp ')' {
            $$ = driver.composeTensorField(
                *$3,*$5,*$7,
                *$9,*$11,*$13,
                *$15,*$17,*$19
...
psymmTensor: TOKEN_SYMM_TENSOR '(' pexp ',' pexp ',' pexp ',' pexp ',' pexp ',' pexp ')' {
            $$ = driver.composeSymmTensorField(
                *$3,*$5,*$7,
                *$9,*$11,
                *$13
...
psphericalTensor: TOKEN_SPHERICAL_TENSOR '(' pexp ')' {
            $$ = driver.composeSphericalTensorField(*$3).ptr();
            delete $3;
          }
