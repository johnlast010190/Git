...
#include "tensorEntryToExpression.H"
...
defineTypeNameAndDebug(tensorEntryToExpression,0);

addNamedToRunTimeSelectionTable(entryToExpression,tensorEntryToExpression, nothing,tensor);

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

tensorEntryToExpression::tensorEntryToExpression()
    :
    entryToExpression()
{
}
