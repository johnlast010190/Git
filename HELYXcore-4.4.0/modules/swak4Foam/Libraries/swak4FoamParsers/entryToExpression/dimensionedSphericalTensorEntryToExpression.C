...
defineTypeNameAndDebug(dimensionedSphericalTensorEntryToExpression,0);

addNamedToRunTimeSelectionTable(entryToExpression,dimensionedSphericalTensorEntryToExpression, nothing,dimensionedSphericalTensor);

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

dimensionedSphericalTensorEntryToExpression::dimensionedSphericalTensorEntryToExpression()
    :
    entryToExpression()
{
}
