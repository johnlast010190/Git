...
#include "ReaderParticle/CloudProxyForReaderParticle.H"
...
const objectRegistry &CloudValueExpressionDriver::db() const
{
    return dynamic_cast<const objectRegistry&>(cloud_.db());
}
