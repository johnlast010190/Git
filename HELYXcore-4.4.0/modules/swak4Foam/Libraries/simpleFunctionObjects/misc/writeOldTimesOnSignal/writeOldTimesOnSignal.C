...
:
    ...
    times_(dict),
    theTime_(t),
    writeCurrent_(dict.lookup<bool>("writeCurrent")),
    sleepSecondsBeforeReraising_
    (
        dict.lookupOrDefault<scalar>("sleepSecondsBeforeReraising", 60)
    ),
    ...
    itWasMeWhoReraised_(false)
{
    if (writeCurrent_)
    {
        ...
        (
            ...
            << "'writeCurrent' was set."
            << " This may lead to uncaught segmentation faults" << endl;
    }
