    ...
    sectionEndSeparator_  ("############ End of: _sectionIdToken_ ############")
{
    ...
    {
        echoControlDictDebugSwitches_ =
            dict.lookup<bool>("echoControlDictDebugSwitches");
    }

    // InfoSwitches
    if (dict.found("echoControlDictInfoSwitches"))
    {
        echoControlDictInfoSwitches_ =
            dict.lookup<bool>("echoControlDictInfoSwitches");
    }

    // OptimisationSwitches
    if (dict.found("echoControlDictOptimisationSwitches"))
    {
        echoControlDictOptimisationSwitches_ =
            dict.lookup<bool>("echoControlDictOptimisationSwitches");
    }

    // Tolerances
    if (dict.found("echoControlDictTolerances"))
    {
        echoControlDictTolerances_ =
            dict.lookup<bool>("echoControlDictTolerances");
    }

    // DimensionedConstants
    if (dict.found("echoControlDictDimensionedConstants"))
    {
        echoControlDictDimensionedConstants_ =
            dict.lookup<bool>("echoControlDictDimensionedConstants");
    }
    ...
    if (dict.found("sectionStartSeparator"))
    {
        sectionStartSeparator_ =
            dict.lookup<string>("sectionStartSeparator");
    }

    // Optional parameter sectionEndSeparator
    if (dict.found("sectionEndSeparator"))
    {
        sectionEndSeparator_ = dict.lookup<string>("sectionEndSeparator");
    }
}
...
bool Foam::trackDictionaryFunctionObject::read(const dictionary& dict)
{
    ...
    if (dict.found("sectionStartSeparator"))
    {
        sectionStartSeparator_ = dict.lookup<string>("sectionStartSeparator");
    }
