...
{
    checkTriggerList(solutionTriggers_, fvSolutionDict());
    checkTriggerList(schemesTriggers_, fvSchemesDict());
}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

bool timeDependentFvSolutionFvSchemesFunctionObject::manipulateFvSolution
(
    const Time& t
)
{
...
bool timeDependentFvSolutionFvSchemesFunctionObject::manipulateFvSchemes
(
    const Time& t
)
{
