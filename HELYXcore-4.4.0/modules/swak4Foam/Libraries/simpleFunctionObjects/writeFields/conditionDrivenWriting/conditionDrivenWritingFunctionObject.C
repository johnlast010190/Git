    ...
    timeForStateChange_(t.value())
{
    switch(writeControlMode_) {
        case scmWriteNTimesteps:
            writeTimesteps_=dict.lookup<label>("writeTimesteps");
            break;
        case scmWriteIntervall:
            writeIntervall_=dict.lookup<scalar>("writeIntervall");
            break;
    ...
    switch(cooldownMode_) {
        case cdmNTimesteps:
            cooldownTimesteps_=dict.lookup<label>("cooldownTimesteps");
            break;
        case cdmIntervall:
            cooldownIntervall_=dict.lookup<scalar>("cooldownIntervall");
            break;
        case cdmRetrigger:
            // to be implemented by subclass
            break;
