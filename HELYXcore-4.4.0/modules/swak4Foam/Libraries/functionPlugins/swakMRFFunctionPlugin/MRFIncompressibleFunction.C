...
#define concreteIncompressibleMRF(fName,FType,methodName)               \
...
concreteIncompressibleMRF(makeAbsolute,volVectorField,makeAbsolute);
concreteIncompressibleMRF(makeAbsoluteSurf,surfaceScalarField,makeAbsolute);
concreteIncompressibleMRF(makeRelative,volVectorField,makeRelative);
concreteIncompressibleMRF(makeRelativeSurf,surfaceScalarField,makeRelative);
#else
concreteIncompressibleMRF(makeAbsolute,volVectorField,absoluteVelocity);
concreteIncompressibleMRF(makeAbsoluteSurf,surfaceScalarField,absoluteFlux);
concreteIncompressibleMRF(makeRelative,volVectorField,relativeVelocity);
concreteIncompressibleMRF(makeRelativeSurf,surfaceScalarField,relativeFlux);
#endif
