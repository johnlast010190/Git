...
(
    ...
    dimensioned<typename T::value_type> init("nix",dim,pTraits<typename T::value_type>::zero);
    ...
    forAll(timeDirs, timeI)
    {
        ...
        if (args.options().found("field")) {
            ...
            forAll(parts,partI) {
                ...
                if (setDimension) {
                    dim = part.lookup<dimensionSet>("dimension");
                }
