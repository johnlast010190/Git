...
:
    ...
    Hn_(coeffDict_.lookup<scalar>("height1")),
    Hm_(coeffDict_.lookup<scalar>("height2")),
    h_(coeffDict_.lookup<scalar>("depth")),
    omega1n_(coeffDict_.lookup<scalar>("omega1")),
    omega1m_(coeffDict_.lookup<scalar>("omega2")),
    periodn_(2*PI_/omega1n_),
    periodm_(2*PI_/omega1m_),
    phin_(coeffDict_.lookup<scalar>("phi1")),
    phim_(coeffDict_.lookup<scalar>("phi2")),
