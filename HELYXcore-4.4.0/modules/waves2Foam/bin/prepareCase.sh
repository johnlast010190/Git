...
if [ $HELYX_PROJECT_VERSION_NUMBER -lt 230 ]
then
...
if [ $HELYX_PROJECT_VERSION_NUMBER -lt 170 ]
then
...
then
    ...
    then
        ...
        if [ $HELYX_PROJECT_VERSION_NUMBER -lt 400 ]
        then
            sed 's/object      pd.org;/object      p_rgh;/' < 0.org/pd.org > 0/p_rgh
        else
...
if [ $HELYX_PROJECT_VERSION_NUMBER -lt 230 -o $FOAMEXTENDPROJECT -eq 1 ]
then
