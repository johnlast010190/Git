...
Description
    This file encodes settings for the Linux Clang build.
...
# HELYX_COMPILER_NAME is a user-friendly name for CMAKE_C_COMPILER.  It has no bearing on the
# compiler that will be used - it's only used to name subdirectories in the
# following locations:
...
# HELYX_COMPILER_NAME is usually the same as CMAKE_C_COMPILER but with the first letter
# capitalised, sometimes followed by the first two digits of the compiler
# version number (e.g. "Gcc", "Gcc71", etc...)
# By default CMake will derive HELYX_COMPILER_NAME from CMAKE_C_COMPILER, but HELYX_COMPILER
# can be set manually as follows:
