...
)
{
    ...
    hTread_ = dict.lookup<scalar>("treadHeight");
    tWidth_ = dict.lookup<scalar>("tyreWidth");
    distToGround_ = dict.lookup<scalar>("distToGround");
    alphaContact_ = dict.lookup<scalar>("contactAngle");
