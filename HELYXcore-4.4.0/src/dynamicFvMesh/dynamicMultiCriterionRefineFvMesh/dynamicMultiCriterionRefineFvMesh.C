...
void Foam::dynamicMultiCriterionRefineFvMesh::updateRefinementField()
{
    ...
    else
    {
        ...
        forAll(fieldNames, i)
        {
            ...
            const scalar minValue = fields_[dictName].lookup<scalar>("minValue");
            const scalar maxValue = fields_[dictName].lookup<scalar>("maxValue");
            const label refineLevel = fields_[dictName].lookup<label>("refineLevel");
        ...
        forAll(interfaceRefineField, i)
        {
            ...
            scalar innerRefLayers = interface_[fldName].lookup<scalar>("innerRefLayers");
            scalar outerRefLayers = interface_[fldName].lookup<scalar>("outerRefLayers");
            ...
            if (interface_[fldName].found("interfaceLayers"))
            {
                ...
                nAddLayers = interface_[fldName].lookup<scalar>("nAddLayers");
            }
            ...
            {
                refineLevel = interface_[fldName].lookup<scalar>("maxRefineLevel");
