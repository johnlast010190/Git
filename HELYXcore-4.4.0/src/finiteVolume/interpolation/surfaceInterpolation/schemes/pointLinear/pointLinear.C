...
Foam::pointLinear<Type>::correction(const VolField<Type>& vf) const
{
    ...
    tmp<SurfaceField<Type>> tsfCorr = linearInterpolate(vf);
    ...
    typename SurfaceField<Type>::Boundary& bSfCorr =
        tsfCorr.ref().boundaryFieldRef();
