...
#include "interpolation/surfaceInterpolation/schemes/deferred/deferred.H"
...
Foam::deferred<Type>::correction(const VolField<Type>& vf) const
{
    ...
    typename SurfaceField<Type>::Boundary& bSfCorr = sfCorr.boundaryFieldRef();
