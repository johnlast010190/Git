...
#include "interpolation/surfaceInterpolation/limitedSchemes/bjSlope/bjSlope.H"

// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //

namespace Foam
{
    makeLimitedSurfaceInterpolationScheme(bjSlope, bjSlopeLimiter)
    makeLimitedVSurfaceInterpolationScheme(bjSlopeV, bjSlopeLimiter)
