...
#include "interpolation/surfaceInterpolation/limitedSchemes/ROUND/ROUNDL.H"

// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //

namespace Foam
{
    makeLimitedSurfaceInterpolationScheme(ROUNDL, ROUNDLLimiter)
    makeLimitedVSurfaceInterpolationScheme(ROUNDLV, ROUNDLLimiter)
