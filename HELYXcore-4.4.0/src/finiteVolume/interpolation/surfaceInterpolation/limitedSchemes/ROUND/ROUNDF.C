...
#include "interpolation/surfaceInterpolation/limitedSchemes/ROUND/ROUNDF.H"

// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //

namespace Foam
{
    makeLimitedSurfaceInterpolationScheme(ROUNDF, ROUNDFLimiter)
    makeLimitedVSurfaceInterpolationScheme(ROUNDFV, ROUNDFLimiter)
