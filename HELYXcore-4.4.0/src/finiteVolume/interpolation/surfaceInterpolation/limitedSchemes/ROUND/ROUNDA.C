...
#include "interpolation/surfaceInterpolation/limitedSchemes/ROUND/ROUNDA.H"

// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //

namespace Foam
{
    makeLimitedSurfaceInterpolationScheme(ROUNDA, ROUNDALimiter)
    makeLimitedVSurfaceInterpolationScheme(ROUNDAV, ROUNDALimiter)
