...
#include "interpolation/surfaceInterpolation/limitedSchemes/ROUND/ROUNDAplus.H"

// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //

namespace Foam
{
    makeLimitedSurfaceInterpolationScheme(ROUNDAplus, ROUNDAplusLimiter)
    makeLimitedVSurfaceInterpolationScheme(ROUNDAplusV, ROUNDAplusLimiter)
