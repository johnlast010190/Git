...
#include "interpolation/surfaceInterpolation/limitedSchemes/dlSlope/dlSlope.H"

// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //

namespace Foam
{
    makeLimitedSurfaceInterpolationScheme(dlSlope, dlSlopeLimiter)
    makeLimitedVSurfaceInterpolationScheme(dlSlopeV, dlSlopeLimiter)
