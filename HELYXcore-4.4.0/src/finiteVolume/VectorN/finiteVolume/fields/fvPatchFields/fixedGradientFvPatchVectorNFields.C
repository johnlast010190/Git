...
#include "VectorN/finiteVolume/fields/fvPatchFields/fixedGradientFvPatchVectorNFields.H"
#include "db/runTimeSelection/construction/addToRunTimeSelectionTable.H"
#include "fields/fvPatchFields/basic/fixedGradient/fixedGradientFvPatchField.C"
...
#define doMakePatchTypeField(type, Type, args...)                           \
    makeTemplatePatchTypeField(type, fixedGradient);
