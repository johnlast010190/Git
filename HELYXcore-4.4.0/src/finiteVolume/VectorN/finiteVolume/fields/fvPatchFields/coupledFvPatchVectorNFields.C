...
#include "VectorN/finiteVolume/fields/fvPatchFields/coupledFvPatchVectorNFields.H"
#include "db/runTimeSelection/construction/addToRunTimeSelectionTable.H"
#include "fields/fvPatchFields/basic/coupled/coupledFvPatchField.C"
...
#define doMakePatchTypeField(type, Type, args...)           \
    ...
    INSTANTIATE_CLASS2(type, Type, coupledFvPatchField);
