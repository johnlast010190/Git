...
#include "VectorN/finiteVolume/fields/fvPatchFields/zeroGradientFvPatchVectorNFields.H"
#include "db/runTimeSelection/construction/addToRunTimeSelectionTable.H"
#include "fields/fvPatchFields/basic/zeroGradient/zeroGradientFvPatchField.C"
...
#define doMakePatchTypeField(type, Type, args...)                           \
    makeTemplatePatchTypeField(type, zeroGradient);
