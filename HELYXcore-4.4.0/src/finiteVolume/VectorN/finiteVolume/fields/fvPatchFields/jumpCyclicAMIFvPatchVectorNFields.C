...
#include "VectorN/finiteVolume/fields/fvPatchFields/jumpCyclicAMIFvPatchVectorNFields.H"
...
#define doMakePatchTypeField(type, Type, args...)           \
    makePatchTypeFieldTypeName(jumpCyclicAMIFvPatch##Type##Field);            \
    INSTANTIATE_CLASS2(type, Type, jumpCyclicAMIFvPatchField);
