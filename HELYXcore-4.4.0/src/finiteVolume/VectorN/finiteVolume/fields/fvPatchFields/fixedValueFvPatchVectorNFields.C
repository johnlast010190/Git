...
#include "VectorN/finiteVolume/fields/fvPatchFields/fixedValueFvPatchVectorNFields.H"
#include "db/runTimeSelection/construction/addToRunTimeSelectionTable.H"
#include "fields/fvPatchFields/basic/fixedValue/fixedValueFvPatchField.C"
...
#define doMakePatchTypeField(type, Type, args...)               \
    makeTemplatePatchTypeField(type, fixedValue);
