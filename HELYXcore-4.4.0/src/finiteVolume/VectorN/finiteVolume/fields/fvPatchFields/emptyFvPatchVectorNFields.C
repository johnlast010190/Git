...
#include "VectorN/finiteVolume/fields/fvPatchFields/emptyFvPatchVectorNFields.H"
#include "db/runTimeSelection/construction/addToRunTimeSelectionTable.H"
#include "fields/fvPatchFields/constraint/empty/emptyFvPatchField.C"
...
#define doMakePatchTypeField(type, Type, args...)           \
    makeTemplatePatchTypeField(type, empty);
