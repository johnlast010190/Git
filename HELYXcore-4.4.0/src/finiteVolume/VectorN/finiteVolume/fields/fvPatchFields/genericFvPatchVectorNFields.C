...
#include "VectorN/finiteVolume/fields/fvPatchFields/genericFvPatchVectorNFields.H"
...
#include "genericFvPatchFields/genericFvPatchField.C"
...
#define doMakePatchTypeField(type, Type, args...)           \
    ...
    INSTANTIATE_CLASS2(type, Type, genericFvPatchField);
