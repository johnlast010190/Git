...
#include "VectorN/finiteVolume/fields/fvPatchFields/internalFvPatchVectorNFields.H"
#include "db/runTimeSelection/construction/addToRunTimeSelectionTable.H"
#include "fields/fvPatchFields/constraint/internal/internalFvPatchField.C"
...
#define doMakePatchTypeField(type, Type, args...)                             \
    makeTemplatePatchTypeField(type, internal);
