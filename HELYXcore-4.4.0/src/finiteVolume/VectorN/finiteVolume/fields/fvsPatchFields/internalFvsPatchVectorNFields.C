...
#include "VectorN/finiteVolume/fields/fvsPatchFields/internalFvsPatchVectorNFields.H"
...
#define doMakeFvsPatchTypeField(type, Type, args...)                          \
    makeFvsPatchTypeField(fvsPatch##Type##Field, internalFvsPatch##Type##Field);
