...
Foam::basicSymmetryFvPatchField<Type>::transformationField() const
{
    tmp<vectorField> nHat = this->patch().nf();
    return tmp<Field<tensor>>(nHat*nHat);
}


template<class Type>
Foam::tmp<Foam::Field<Type>>
Foam::basicSymmetryFvPatchField<Type>::gradientBoundaryValue() const
{
