...
void Foam::surfaceNormalFixedValueFvPatchVectorField::boundaryRelaxMatrix
(
    fvBlockMatrix<Foam::vector>& bEq
) const
{
    if (relax_ < 1)
    {
...
void Foam::surfaceNormalFixedValueFvPatchVectorField::write(Ostream& os) const
{
    ...
    writeEntryIfDifferent<scalar>(os, "relax", scalar(1) , relax_);
}
