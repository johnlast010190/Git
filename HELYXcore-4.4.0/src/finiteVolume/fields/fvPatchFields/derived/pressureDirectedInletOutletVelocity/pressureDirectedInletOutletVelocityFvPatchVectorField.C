...
#include "fields/fvPatchFields/derived/pressureDirectedInletOutletVelocity/pressureDirectedInletOutletVelocityFvPatchVectorField.H"
...
void Foam::pressureDirectedInletOutletVelocityFvPatchVectorField::autoMapGIB
(
