...
#include "fields/fvPatchFields/derived/waveSurfacePressure/waveSurfacePressureFvPatchScalarField.H"
...
void Foam::waveSurfacePressureFvPatchScalarField::updateCoeffs()
{
    ...
    const word ddtSchemeName(zeta.mesh().schemes().ddtScheme(zeta.name()));
