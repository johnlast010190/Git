...
#include "fields/fvPatchFields/derived/pressureInletVelocity/pressureInletVelocityFvPatchVectorField.H"
...
{
    fvPatchField<vector>::forceAssign(patch().nf()*(patch().nf() & pvf));
}
