...
Foam::wedgeFvPatchField<Type>::transformationField() const
{
    ...
    (
        ...
        (
            this->size(),
            0.5*(I - refCast<const wedgeFvPatch>(this->patch()).cellT())
        )
    );
}
...
template<class Type>
Foam::tmp<Foam::Field<Type>>
Foam::wedgeFvPatchField<Type>::valueDivInternalCoeffs
(
...
template<class Type>
Foam::tmp<Foam::Field<Type>>
Foam::wedgeFvPatchField<Type>::valueDivBoundaryCoeffs
(
    const tmp<Field<scalar>>& w
) const
{
