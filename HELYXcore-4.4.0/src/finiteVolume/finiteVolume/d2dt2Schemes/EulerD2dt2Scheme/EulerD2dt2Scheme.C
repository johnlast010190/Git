...
template<class Type>
tmp<VolField<Type>> EulerD2dt2Scheme<Type>::fvcD2dt2(const VolField<Type>& vf)
{
...
template<class Type>
tmp<VolField<Type>> EulerD2dt2Scheme<Type>::fvcD2dt2
(
...
template<class Type>
tmp<fvMatrix<Type>> EulerD2dt2Scheme<Type>::fvmD2dt2
(
    const VolField<Type>& vf
)
{
