...
template<class Type>
fixedDdtScheme<Type>::fixedDdtScheme(const fvMesh& mesh, Istream& is)
:
...
template<class Type>
tmp<VolField<Type>> fixedDdtScheme<Type>::fvcDdt(const dimensioned<Type>& dt)
{
...
template<class Type>
tmp<VolField<Type>> fixedDdtScheme<Type>::fvcDdt(const VolField<Type>& vf)
{
...
template<class Type>
tmp<VolField<Type>> fixedDdtScheme<Type>::fvcDdt
(
...
template<class Type>
tmp<fvMatrix<Type>> fixedDdtScheme<Type>::fvmDdt(const VolField<Type>& vf)
{
...
template<class Type>
tmp<fvMatrix<Type>> fixedDdtScheme<Type>::fvmDdt
(
    const dimensionedScalar& rho,
    const VolField<Type>& vf
)
...
template<class Type>
tmp<scalarField> fixedDdtScheme<Type>::meshPhi
(
    const VolField<Type>& vf,
    const label patchi
)
