...
SINCSnGrad<Type>::correction(const VolField<Type>&) const
{
    NotImplemented;
}
...
) const
{
    ...
    SurfaceField<Type>& deltaCoeffs = tdeltaCoeffs.ref();
    ...
    nonOrthCorr /= dimensionedScalar("p", vf.dimensions(), 1);
