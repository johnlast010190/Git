...
)
{
    ...
    ncFieldb.forceAssign(pTraits<Type>::zero);
    ...
    forAll(origPatchIDs, i)
    {
        ...
        if (isFluxField)
        {
            ...
            ncFieldb[origPatchi] *=
               ...
               /max
                (
                    origNcMagSfb[origPatchi],
                    patchToPatch::small*origTotalMagSf
                );
        }
        else
        {
            ...
            ncFieldb[origPatchi] /=
                max(origNcMagSfb[origPatchi], patchToPatch::vSmall);
        }
    }
    ...
    forAll(origPatchIDs, i)
    {
        ...
        if (isFluxField)
        {
            ...
            origFieldb[origPatchi] *=
                origTotalMagSf
               /max(origFvp.magSf(), patchToPatch::small*origTotalMagSf);
        }
    }
...
)
{
    ...
    return
        synchronisedBoundaryField<Type>
        (
            fieldb,
            isFluxField,
            0.5,
