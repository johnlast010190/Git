...
void Foam::fv::option::addAcceleration(fvBlockMatrix<vector>& UEqn) const
{
    frameError("addAcceleration");
}
...
void Foam::fv::option::makeAbsolute(volVectorField& U) const
{
    frameError("makeAbsolute");
}


void Foam::fv::option::zero(surfaceScalarField& tphi) const
{
	frameError("zero");
}
