...
)
{
    forAll(*this, patchI)
    {
        ...
        else if (patchType == nonConformalDiscreteMixingFvPatch::typeName)
        {
            this->set
            (
                patchI,
                fvPatchField<Type>::New
                (
                    nonConformalDiscreteMixingFvPatchField<Type>::typeName,
                    cPatch,
                    iField
                )
            );
    ...
    VolField<Type>::Boundary::evaluatePatchFields
    (
        mesh,
        *this
    );
