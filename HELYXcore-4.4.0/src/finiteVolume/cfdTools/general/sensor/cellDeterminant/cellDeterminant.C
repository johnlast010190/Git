...
#include "cfdTools/general/sensor/cellDeterminant/cellDeterminant.H"
...
template<class Type>
Foam::sensorTypes::cellDeterminant<Type>::cellDeterminant
(
    const fvMesh& mesh,
...
Foam::sensorTypes::cellDeterminant<Type>::valueField() const
{
