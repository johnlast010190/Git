...
#include "nonConformal/pointPatches/nonConformalError/nonConformalErrorPointPatch.H"
...
)
{
    forAll(mesh.boundary(), patchI)
    {
        ...
        else if (isType<cyclicPointPatch>(cPatch))
        {
            dictionary patchDict;
        ...
        else if (patchType == nonConformalCyclicPointPatch::typeName)
        {
            dictionary patchDict;

            patchDict.add("type", nonConformalCyclicPointPatch::typeName);

            dictPtr_->add(patchName, patchDict);
        }
        else if (patchType == nonConformalErrorPointPatch::typeName)
        {
            dictionary patchDict;

            patchDict.add("type", nonConformalErrorPointPatch::typeName);

            dictPtr_->add(patchName, patchDict);
        }
        else if (patchType == nonConformalProcessorCyclicPointPatch::typeName)
        {
            dictionary patchDict;
            ...
            (
                "type",
                nonConformalProcessorCyclicPointPatch::typeName
            );
    ...
    forAll(*this, patchI)
    {
        ...
        else if (patchType == nonConformalCyclicPointPatch::typeName)
        {
            ...
            (
                ...
                pointPatchField<Type>::New
                (
                    nonConformalCyclicPointPatch::typeName,
                    cPatch,
                    iField
                )
            );
        ...
        else if (patchType == nonConformalErrorPointPatch::typeName)
        {
            ...
            (
                ...
                pointPatchField<Type>::New
                (
                    nonConformalErrorPointPatch::typeName,
                    cPatch,
                    iField
                )
            );
