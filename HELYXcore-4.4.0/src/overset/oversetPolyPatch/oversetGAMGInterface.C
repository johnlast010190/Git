    ...
    )
{
    ...
    if (master())
    {
        ...
        // Work the stencil back from global cells into a distributionMap
        // + slots
        List<Map<label>> compactMap;
        mapPtr_.reset(new distributionMap(globalNumbering, stencil_, compactMap));
