...
{
    DebugInformation<< FUNCTION_NAME << " : Start of analysis" << endl;
    ...
    DebugInformation<< FUNCTION_NAME << " : Moved zone sub-meshes" << endl;
    ...
    DebugInformation<< FUNCTION_NAME << " : Constructed cell voxel meshes" << endl;
    ...
    DebugInformation<< FUNCTION_NAME << " : Calculated bounding boxes" << endl;
    ...
    DebugInformation<< FUNCTION_NAME << " : Calculated boundary voxel meshes" << endl;
    ...
    DebugInformation<< FUNCTION_NAME << " : Allocated donor-cell structures" << endl;
    ...
    DebugInformation<< FUNCTION_NAME << " : Determined holes and donor-acceptors"
        << endl;
    ...
    DebugInformation<< FUNCTION_NAME << " : Removed bad donors" << endl;

    // Mark unreachable bits
    findHoles(globalCells_, mesh_, zoneID, allStencil, allCellTypes);
    DebugInformation<< FUNCTION_NAME << " : Flood-filled holes" << endl;
    ...
    DebugInformation<< FUNCTION_NAME << " : Implemented layer relaxation" << endl;
    ...
    DebugInformation<< FUNCTION_NAME << " : Transferred donor to stencil" << endl;


    // Extend stencil to get inverse distance weighted neighbours
    createStencil(globalCells);
    DebugInformation<< FUNCTION_NAME << " : Extended stencil" << endl;
    ...
    DebugInformation<< FUNCTION_NAME << " : Finished analysis" << endl;
