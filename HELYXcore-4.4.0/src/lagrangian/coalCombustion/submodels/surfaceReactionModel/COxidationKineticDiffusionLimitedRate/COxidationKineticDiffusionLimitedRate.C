...
#include "submodels/surfaceReactionModel/COxidationKineticDiffusionLimitedRate/COxidationKineticDiffusionLimitedRate.H"
    ...
    HcCO2_(0.0)
{
    ...
    HcCO2_ = const_cast<SLGThermo&>(owner.thermo()).hf(CO2GlobalId_);
