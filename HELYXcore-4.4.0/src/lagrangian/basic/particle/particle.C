...
#if defined(HELYX_SP)
const Foam::scalar Foam::particle::trackingCorrectionTol = 1e-1;
const Foam::scalar Foam::particle::lambdaDistanceToleranceCoeff = 1e-12;
const Foam::scalar Foam::particle::minStepFractionTol = 1e-10;
#else
