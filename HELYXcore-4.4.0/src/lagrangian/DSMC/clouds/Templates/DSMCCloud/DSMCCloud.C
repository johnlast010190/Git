...
)
{
    ...
    (
        dsmcInitialiseDict.lookup<scalar>("temperature")
    );
...
void Foam::DSMCCloud<ParcelType>::resetFields()
{
    ...
    fD_ = dimensionedVector(dimensionSet(1, -1, -2, 0, 0), Zero);
    ...
    momentum_ = dimensionedVector(dimensionSet(1, -2, -1, 0, 0), Zero);
}
...
:
    ...
    nParticle_(particleProperties_.lookup<scalar>("nEquivalentParticles")),
