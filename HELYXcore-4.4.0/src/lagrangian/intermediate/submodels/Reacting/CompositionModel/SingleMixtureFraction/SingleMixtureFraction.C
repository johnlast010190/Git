    ...
    YMixture0_(3)
{
    ...
    YMixture0_[idGas_] = this->coeffDict().template lookup<scalar>("YGasTot0");
    YMixture0_[idLiquid_] =
        this->coeffDict().template lookup<scalar>("YLiquidTot0");
    YMixture0_[idSolid_] =
        this->coeffDict().template lookup<scalar>("YSolidTot0");
