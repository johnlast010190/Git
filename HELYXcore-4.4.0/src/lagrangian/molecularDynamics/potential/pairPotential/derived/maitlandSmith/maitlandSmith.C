...
:
    ...
    m_(maitlandSmithCoeffs_.lookup<scalar>("m")),
    gamma_(maitlandSmithCoeffs_.lookup<scalar>("gamma")),
    rm_(maitlandSmithCoeffs_.lookup<scalar>("rm")),
    epsilon_(maitlandSmithCoeffs_.lookup<scalar>("epsilon"))
{
    setLookupTables();
}
