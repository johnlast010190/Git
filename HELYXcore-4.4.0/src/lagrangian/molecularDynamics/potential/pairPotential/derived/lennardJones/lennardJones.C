...
#include "pairPotential/derived/lennardJones/lennardJones.H"
...
:
    ...
    sigma_(lennardJonesCoeffs_.lookup<scalar>("sigma")),
    epsilon_(lennardJonesCoeffs_.lookup<scalar>("epsilon"))
{
    setLookupTables();
}
