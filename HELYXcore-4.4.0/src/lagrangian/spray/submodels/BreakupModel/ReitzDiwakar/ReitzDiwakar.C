    ...
    Cs_(10.0)
{
    ...
    {
        Cbag_ = this->coeffDict().template lookup<scalar>("Cbag");
        Cb_ = this->coeffDict().template lookup<scalar>("Cb");
        Cstrip_ = this->coeffDict().template lookup<scalar>("Cstrip");
        Cs_ = this->coeffDict().template lookup<scalar>("Cs");
    }
}
