...
)
{
    ...
    IOField<scalar> d0(c.fieldIOobject("d0", IOobject::MUST_READ), read);
    ...
    IOField<scalar> sigma(c.fieldIOobject("sigma", IOobject::MUST_READ), read);
    c.checkFieldIOobject(c, sigma);

    IOField<scalar> mu(c.fieldIOobject("mu", IOobject::MUST_READ), read);
