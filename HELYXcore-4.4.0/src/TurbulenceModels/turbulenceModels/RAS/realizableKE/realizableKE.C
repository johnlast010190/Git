...
void realizableKE<BasicEddyViscosityModel>::segregatedCorrect()
{
    // Local references
    ...
    volScalarField eta(modelName("eta"), magS*k_/epsilon_);
    volScalarField C1
    (
        modelName("C1"),
...
template<class BasicEddyViscosityModel>
void realizableKE<BasicEddyViscosityModel>::coupledCorrect()
{
