...
template<class BasicTurbulenceModel>
tmp<volScalarField> RNGkEpsilon<BasicTurbulenceModel>::L() const
{
...
void RNGkEpsilon<BasicTurbulenceModel>::correct()
{
    ...
    volScalarField eta(modelName("eta"), sqrt(mag(S2))*k_/epsilon_);
    volScalarField eta3(modelName("eta3"), eta*sqr(eta));
