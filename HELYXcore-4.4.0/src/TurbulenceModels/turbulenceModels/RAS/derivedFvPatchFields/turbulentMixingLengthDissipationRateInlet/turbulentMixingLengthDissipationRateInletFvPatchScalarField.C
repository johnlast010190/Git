...
:
    ...
    (
        ...
        (
            "k", IOobject::groupName("k", internalField().group())
        )
    )
{
...
void turbulentMixingLengthDissipationRateInletFvPatchScalarField::updateCoeffs()
{
    ...
    const fvPatchScalarField& kp =
        patch().lookupPatchFieldInDb<volScalarField, scalar>(this->db(),kName_);

    const fvsPatchScalarField& phip =
        patch().lookupPatchFieldInDb<surfaceScalarField, scalar>
        (
            this->db(), this->detectPhiName(this->phiName_)
        );
...
) const
{
    ...
    os.writeEntryIfDifferent("phi", word::null, this->phiName_);
    os.writeEntryIfDifferent
    (
        "k", IOobject::groupName("k", internalField().group()), kName_
    );
    writeEntry("value", os);
}
...
void turbulentMixingLengthDissipationRateInletFvPatchScalarField::operator=
(
