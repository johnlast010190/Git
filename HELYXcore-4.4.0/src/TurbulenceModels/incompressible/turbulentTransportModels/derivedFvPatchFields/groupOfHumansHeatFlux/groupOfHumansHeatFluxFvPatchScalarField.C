...
<Foam::incompressible::groupOfHumansHeatFluxFvPatchScalarField::eGroup, 4>::names[] =
{
    "maleAdult",
    "femaleAdult",
    "maleChild",
...
const Foam::NamedEnum
    <Foam::incompressible::groupOfHumansHeatFluxFvPatchScalarField::eGroup, 4>
    Foam::incompressible::groupOfHumansHeatFluxFvPatchScalarField::eGroupNames_;
...
{
    return (0.202 * Foam::pow(W, 0.425) * Foam::pow(H, 0.725));
}
...
:
    ...
    dlocal_(dict.lookup<scalar>("averagingDistance")),
...
void groupOfHumansHeatFluxFvPatchScalarField::updateCoeffs()
{
...

    {
        ...
        if (transportProperties.found("pRef"))
        {
            PRef =
