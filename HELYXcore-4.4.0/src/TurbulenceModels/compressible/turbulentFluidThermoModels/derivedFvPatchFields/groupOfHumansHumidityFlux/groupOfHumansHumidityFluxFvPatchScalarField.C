...
#include "turbulentFluidThermoModels/derivedFvPatchFields/groupOfHumansHeatFlux/groupOfHumansHeatFluxFvPatchScalarField.H"
...
(
    fvPatchScalarField,
    groupOfHumansHumidityFluxFvPatchScalarField,
    compressible::groupOfHumansHumidityFlux,
    compressible__groupOfHumansHumidityFlux
);
