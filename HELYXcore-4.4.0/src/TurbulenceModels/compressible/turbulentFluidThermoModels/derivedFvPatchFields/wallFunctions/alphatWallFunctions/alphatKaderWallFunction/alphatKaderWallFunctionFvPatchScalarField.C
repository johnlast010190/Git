...
void alphatKaderWallFunctionFvPatchScalarField::updateCoeffs()
{
    ...
    const word group(internalField().group());
    ...
    const basicThermo& thermo =
        ...
        (
            IOobject::groupName(basicThermo::dictName, group)
        );
    ...
    // NOTE: This was 0.1 instead of SMALL
...
(
    fvPatchScalarField,
    alphatKaderWallFunctionFvPatchScalarField,
    compressible::alphatKaderWallFunction,
    compressible__alphatKaderWallFunction
);
