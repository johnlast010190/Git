...
#include "turbulentFluidThermoModels/derivedFvPatchFields/outletMachNumberPressure/outletMachNumberPressureFvPatchScalarField.H"
...
:
    ...
    pBack_(dict.lookup<scalar>("pBack")),
...
void Foam::outletMachNumberPressureFvPatchScalarField::write(Ostream& os) const
{
    ...
    writeEntryIfDifferent<scalar>(os, "c1", 0, c1_);
    writeEntryIfDifferent<scalar>(os, "A1", 0, A1_);
    os.writeEntry("choked", choked_);
    writeEntryIfDifferent<scalar>(os, "relax", 0, relax_);

    writeEntryIfDifferent<word>(os, "phi", "phi", phiName_);
    writeEntryIfDifferent<word>(os, "rho", "rho", rhoName_);
    writeEntryIfDifferent<word>(os, "U", "U", UName_);
    writeEntryIfDifferent<scalar>(os, "M", 0, M_);
