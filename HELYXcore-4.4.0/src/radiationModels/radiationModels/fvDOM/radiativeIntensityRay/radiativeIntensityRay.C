...
const Foam::word
Foam::radiationModels::radiativeIntensityRay::intensityPrefix("ILambda");
...
Foam::radiationModels::radiativeIntensityRay::emittedRadiantIntensity
(
    label patchI,
...
Foam::radiationModels::radiativeIntensityRay::cellQr() const
{
