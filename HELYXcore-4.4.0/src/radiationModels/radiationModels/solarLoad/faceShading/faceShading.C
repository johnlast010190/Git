...
{
    const radiationModels::boundaryRadiationProperties& boundaryRadiation =
        radiationModels::boundaryRadiationProperties::New(mesh_, TRef_);
    ...
    (
        1,
        treeBoundBox(boundBox(mesh_.points(), false)).extend(1e-3)
    );
