...
Foam::radiationModels::wideBandDiffusiveRadiationMixedFvPatchScalarField::
...
void Foam::radiationModels::wideBandDiffusiveRadiationMixedFvPatchScalarField::
updateCoeffs()
{
    if (this->updated())
    {
    ...
    const boundaryRadiationProperties& boundaryRadiation =
        boundaryRadiationProperties::New
        (
            internalField().mesh(), dom.TRef().value()
        );
    ...
    (
        boundaryRadiation.transmissivity(patchi, lambdaId)
    );
...
void Foam::radiationModels::wideBandDiffusiveRadiationMixedFvPatchScalarField::write
(
    Ostream& os
) const
{
