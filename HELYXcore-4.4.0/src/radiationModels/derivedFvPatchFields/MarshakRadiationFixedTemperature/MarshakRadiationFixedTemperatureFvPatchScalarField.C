...
Foam::radiationModels::MarshakRadiationFixedTemperatureFvPatchScalarField::
    ...
    Trad_("Trad", dict, p.size())
{
    ...
    refValue() =
        4.0*constant::physicoChemical::sigma.value()*pow4(Trad_+TRef.value());
...
void Foam::radiationModels::MarshakRadiationFixedTemperatureFvPatchScalarField::
autoMap
(
...
void Foam::radiationModels::MarshakRadiationFixedTemperatureFvPatchScalarField::rmap
(
...
void Foam::radiationModels::MarshakRadiationFixedTemperatureFvPatchScalarField::reset
(
    const fvPatchScalarField& ptf
)
{
...
void
Foam::radiationModels::MarshakRadiationFixedTemperatureFvPatchScalarField::autoMapGIB
(
    const gibFvPatchFieldMapper& mapper
)
{
    mixedFvPatchScalarField::autoMapGIB(mapper);
    mapper.map(Trad_, scalar(0));
}
...
updateCoeffs()
{
    ...
    refValue() =
        4.0*constant::physicoChemical::sigma.value()
       *pow4(Trad_+TRef.value());
...
void Foam::radiationModels::MarshakRadiationFixedTemperatureFvPatchScalarField::write
(
    Ostream& os
) const
{
