...
Foam::autoPtr<Foam::fvMeshGIBChangers::motionFunction>
Foam::fvMeshGIBChangers::motionFunction::New
(
    const fvMesh& mesh,
...
)
{
    ...
    libs.open("libmotionFunctions.so");
    libs.open(SBMFCoeffs, "libs");
    ...
    return
        autoPtr<motionFunction>
        (
            ctor(mesh, SBMFCoeffsi, runTime)
        );
}
