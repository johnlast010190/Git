    ...
    dict_(dict)
{
    if (!dict.found("value"))
    {
        ...
        (
            ...
            << "\n    Using zero as default initial value\n"
            << endl;

        this->fvPatchField<Type>::operator=(pTraits<Type>::zero);
    }
    else
    {
            ...
            if (iter().keyword() != "type" && iter().keyword() != "value")
            {
                ...
                )
                {
                    ...
                    )
                    {
                        ...
                        {
                            sphericalTensorField* fPtr
                                = new sphericalTensorField;
                            fPtr->transfer
                            (
                                dynamicCast
                                <
...
template<class Type>
void Foam::genericFvPatchField<Type>::autoMapGIB
(
    const gibFvPatchFieldMapper& mapper
)
{
    calculatedFvPatchField<Type>::autoMapGIB(mapper);
    ...
    {
        mapper.map(*iter(), sphericalTensor::zero);
    }
    ...
    {
        mapper.map(*iter(), symmTensor::zero);
    }
