...
void processorFaPatch::initTopoChange(PstreamBuffers& pBufs)
{
    // For completeness
    faPatch::initTopoChange(pBufs);
    deleteDemandDrivenData(nbrPointsPtr_);
...
void processorFaPatch::topoChange(PstreamBuffers& pBufs)
{
    // For completeness
    faPatch::topoChange(pBufs);
