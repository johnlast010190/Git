...
#include "../../interfacialCompositionModels/eulerianInterfaceCompositionModels/eulerianInterfaceCompositionModel/eulerianInterfaceCompositionModel.H"
...
{
    this->createSubModels(interfaceCompositionModels_, true);
}
...
massTransfer() const
{
    ...
    {
        const eulerianInterfaceCompositionModel& compositionModel
        (
            interfaceCompositionModelIter()
        );
        ...
        const phasePairKey key(phase.name(), otherPhase.name(), false);
...
correctThermo()
{
    ...
    )
    {
        ...
        dimensionedScalar HSmall("small", eulerianHeatTransferModel::dimK, SMALL);
