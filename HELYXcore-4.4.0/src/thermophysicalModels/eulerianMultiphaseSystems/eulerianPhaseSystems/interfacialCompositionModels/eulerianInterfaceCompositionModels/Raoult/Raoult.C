...
Foam::eulerianInterfaceCompositionModels::Raoult::Raoult
(
    ...
    )
{
    forAllConstIter(hashedWordList, species(), iter)
    {
        ...
        (
            *iter,
            autoPtr<eulerianInterfaceCompositionModel>
            (
...
void Foam::eulerianInterfaceCompositionModels::Raoult::update
(
...
)
{
    ...
    forAllIter
    (
        HashTable<autoPtr<eulerianInterfaceCompositionModel>>,
        speciesModels_,
        iter
    )
    {
...
Foam::eulerianInterfaceCompositionModels::Raoult::Yf
(
...
Foam::tmp<Foam::volScalarField>
Foam::eulerianInterfaceCompositionModels::Raoult::YfPrime
(
    const word& speciesName,
    const volScalarField& Tf
) const
{
    ...
    {
        return otherComposition().Y(speciesName)*YNonVapourPrime_;
    }
}
