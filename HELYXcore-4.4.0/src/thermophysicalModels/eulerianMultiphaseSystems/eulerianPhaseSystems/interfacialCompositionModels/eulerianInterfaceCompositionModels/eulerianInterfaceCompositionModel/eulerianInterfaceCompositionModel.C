...
namespace Foam
{
    defineTypeNameAndDebug(eulerianInterfaceCompositionModel, 0);
    defineRunTimeSelectionTable(eulerianInterfaceCompositionModel, dictionary);
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::eulerianInterfaceCompositionModel::eulerianInterfaceCompositionModel
(
...
Foam::tmp<Foam::volScalarField> Foam::eulerianInterfaceCompositionModel::dY
(
...
Foam::tmp<Foam::volScalarField> Foam::eulerianInterfaceCompositionModel::D
(
    const word& speciesName
) const
{
...
Foam::tmp<Foam::volScalarField> Foam::eulerianInterfaceCompositionModel::L
(
    const word& speciesName,
    const volScalarField& Tf
) const
...
void Foam::eulerianInterfaceCompositionModel::addMDotL
(
