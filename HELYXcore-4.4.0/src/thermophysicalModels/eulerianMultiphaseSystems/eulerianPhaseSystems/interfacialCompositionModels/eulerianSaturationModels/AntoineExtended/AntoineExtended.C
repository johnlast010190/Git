...
Foam::eulerianSaturationModels::AntoineExtended::AntoineExtended
(
...
Foam::eulerianSaturationModels::AntoineExtended::pSat
(
...
Foam::tmp<Foam::volScalarField>
Foam::eulerianSaturationModels::AntoineExtended::pSatPrime
(
    const volScalarField& T
) const
{
...
Foam::tmp<Foam::volScalarField>
Foam::eulerianSaturationModels::AntoineExtended::lnPSat
(
    const volScalarField& T
) const
{
...
Foam::tmp<Foam::volScalarField>
Foam::eulerianSaturationModels::AntoineExtended::Tsat
(
