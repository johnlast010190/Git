...
namespace eulerianDragModels
{
    ...
    addToRunTimeSelectionTable(eulerianDragModel, WenYu, dictionary);
}
}
...
Foam::eulerianDragModels::WenYu::WenYu
(
...
Foam::tmp<Foam::volScalarField> Foam::eulerianDragModels::WenYu::CdRe() const
{
