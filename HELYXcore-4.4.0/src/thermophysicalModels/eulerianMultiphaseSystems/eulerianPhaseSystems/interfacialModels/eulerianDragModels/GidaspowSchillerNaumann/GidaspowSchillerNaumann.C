...
namespace eulerianDragModels
{
    ...
    addToRunTimeSelectionTable(eulerianDragModel, GidaspowSchillerNaumann, dictionary);
}
}
...
Foam::eulerianDragModels::GidaspowSchillerNaumann::GidaspowSchillerNaumann
(
...
Foam::eulerianDragModels::GidaspowSchillerNaumann::CdRe() const
{
