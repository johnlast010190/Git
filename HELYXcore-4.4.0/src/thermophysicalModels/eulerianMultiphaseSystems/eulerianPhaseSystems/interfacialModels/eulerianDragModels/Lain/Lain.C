...
namespace eulerianDragModels
{
    ...
    addToRunTimeSelectionTable(eulerianDragModel, Lain, dictionary);
}
}
...
Foam::eulerianDragModels::Lain::Lain
(
...
Foam::tmp<Foam::volScalarField> Foam::eulerianDragModels::Lain::CdRe() const
{
