...
namespace eulerianDragModels
{
    ...
    addToRunTimeSelectionTable(eulerianDragModel, SyamlalOBrien, dictionary);
}
}
...
Foam::eulerianDragModels::SyamlalOBrien::SyamlalOBrien
(
...
Foam::tmp<Foam::volScalarField> Foam::eulerianDragModels::SyamlalOBrien::CdRe() const
{
    volScalarField alpha2
    (
        max(scalar(1) - pair_.dispersed().volFrac(), pair_.continuous().residualAlpha())
    );
