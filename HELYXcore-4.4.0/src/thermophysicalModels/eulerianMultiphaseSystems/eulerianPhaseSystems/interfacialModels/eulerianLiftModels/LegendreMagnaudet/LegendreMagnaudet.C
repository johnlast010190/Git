...
namespace eulerianLiftModels
{
    ...
    addToRunTimeSelectionTable(eulerianLiftModel, LegendreMagnaudet, dictionary);
}
}
...
Foam::eulerianLiftModels::LegendreMagnaudet::LegendreMagnaudet
(
...
Foam::tmp<Foam::volScalarField> Foam::eulerianLiftModels::LegendreMagnaudet::Cl() const
{
