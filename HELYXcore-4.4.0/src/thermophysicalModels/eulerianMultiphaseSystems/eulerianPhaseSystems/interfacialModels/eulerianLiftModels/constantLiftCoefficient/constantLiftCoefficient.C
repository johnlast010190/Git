...
namespace eulerianLiftModels
{
    ...
    addToRunTimeSelectionTable(eulerianLiftModel, constantLiftCoefficient, dictionary);
}
}
...
Foam::eulerianLiftModels::constantLiftCoefficient::constantLiftCoefficient
(
...
Foam::eulerianLiftModels::constantLiftCoefficient::Cl() const
{
