...
Foam::eulerianVirtualMassModels::constantVirtualMassCoefficient::
constantVirtualMassCoefficient
(
...
Foam::eulerianVirtualMassModels::constantVirtualMassCoefficient::Cvm() const
{
    const fvMesh& mesh = this->pair_.phase1().mesh();
    return volScalarField::New("Cvm", mesh, Cvm_);
}
