...
Foam::autoPtr<Foam::eulerianVirtualMassModel> Foam::eulerianVirtualMassModel::New
(
...
{
    word virtualMassModelType(dict.lookup(modelType));
    ...
    return ctor(dict.subOrEmptyDict(modelType+"Coeffs"), pair, true);
}
