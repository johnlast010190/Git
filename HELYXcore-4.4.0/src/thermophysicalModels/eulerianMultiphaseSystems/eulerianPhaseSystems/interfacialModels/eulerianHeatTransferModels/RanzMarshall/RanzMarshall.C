...
namespace eulerianHeatTransferModels
{
    ...
    addToRunTimeSelectionTable(eulerianHeatTransferModel, RanzMarshall, dictionary);
}
}
...
Foam::eulerianHeatTransferModels::RanzMarshall::RanzMarshall
(
...
Foam::eulerianHeatTransferModels::RanzMarshall::K(const scalar residualAlpha) const
{
