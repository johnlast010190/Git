...
Foam::eulerianWallLubricationModels::noWallLubrication::noWallLubrication
(
...
Foam::eulerianWallLubricationModels::noWallLubrication::Fi() const
{
...
Foam::tmp<Foam::volVectorField>
Foam::eulerianWallLubricationModels::noWallLubrication::F() const
{
    const fvMesh& mesh = this->pair_.phase1().mesh();
