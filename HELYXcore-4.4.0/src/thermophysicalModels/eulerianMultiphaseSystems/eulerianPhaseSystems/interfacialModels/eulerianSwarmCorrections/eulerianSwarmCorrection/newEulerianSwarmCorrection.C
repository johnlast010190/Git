...
#include "eulerianSwarmCorrection.H"
#include "../../../eulerianPhasePair/eulerianPhasePair/eulerianPhasePair.H"

// * * * * * * * * * * * * * * * * Selector  * * * * * * * * * * * * * * * * //

Foam::autoPtr<Foam::eulerianSwarmCorrection>
Foam::eulerianSwarmCorrection::New
(
...
{
    word swarmCorrectionType(dict.lookup(modelType));
