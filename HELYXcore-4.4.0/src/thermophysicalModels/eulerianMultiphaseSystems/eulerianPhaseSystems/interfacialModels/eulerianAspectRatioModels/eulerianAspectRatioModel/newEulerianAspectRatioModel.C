...
#include "eulerianAspectRatioModel.H"
#include "../../../eulerianPhasePair/eulerianPhasePair/eulerianPhasePair.H"

// * * * * * * * * * * * * * * * * Selector  * * * * * * * * * * * * * * * * //

Foam::autoPtr<Foam::eulerianAspectRatioModel>
Foam::eulerianAspectRatioModel::New
(
...
{
    word aspectRatioModelType(dict.lookup(modelType));
