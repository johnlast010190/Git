...
Foam::hFunctionTThermo<EquationOfState>::hFunctionTThermo
(
...
:
    ...
    Cp_(Function1<scalar>::New("Cp", dict.subDict("thermodynamics")))
{}
...
template<class EquationOfState>
void Foam::hFunctionTThermo<EquationOfState>::write
(
    Ostream& os
) const
{
