...
namespace Foam
{
    // Dummy interface to for new material library
    defineReaction(,dummyThermo);
    makeIRNReactions(ArrheniusReactionRate, dummyThermo);
    makeIRNReactions(LandauTellerReactionRate, dummyThermo);
    makeIRNReactions(thirdBodyArrheniusReactionRate, dummyThermo);
    makeIRReactions(JanevReactionRate, dummyThermo);
    makeIRReactions(powerSeriesReactionRate, dummyThermo);
