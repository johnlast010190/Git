...
:
    ...
    turb_(nullptr),
    nbrTurb_(nullptr),
    diffusionLimited_(dict.lookupOrDefault<Switch>("diffusionLimited", false))
{}
...
void Foam::semiPermeableBaffleMassFractionFvPatchScalarField::
lookupProperties() const
{
