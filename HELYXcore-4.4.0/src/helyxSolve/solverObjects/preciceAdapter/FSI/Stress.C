...
void preciceAdapter::FSI::Stress::write
(
    double* buffer,
...
bool preciceAdapter::FSI::Stress::isLocationTypeSupported
(
...
preciceAdapter::FSI::Stress::getFaceVectors(const unsigned int patchID) const
{
    // face normal vectors
