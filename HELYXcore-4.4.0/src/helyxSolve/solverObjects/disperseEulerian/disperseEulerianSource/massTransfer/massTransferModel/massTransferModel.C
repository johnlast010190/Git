...
Foam::decoupledEulerian::massTransferModel::massTransferModel
(
...
Foam::decoupledEulerian::massTransferModel::mDot() const
{
    return 6 * phase_.alphad() * Sh() / sqr(phase_.diam()) * phase_.Dc();
}
