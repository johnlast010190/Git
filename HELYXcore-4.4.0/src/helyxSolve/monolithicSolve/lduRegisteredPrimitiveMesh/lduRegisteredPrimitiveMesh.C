...
#include "lduRegisteredPrimitiveMesh.H"
...
namespace Foam
{
    defineTypeNameAndDebug(lduRegisteredPrimitiveMesh, 0);
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::lduRegisteredPrimitiveMesh::lduRegisteredPrimitiveMesh
(
    const label nCells,
    labelList& l,
    labelList& u,
...
:
    lduPrimitiveMesh(nCells, l, u, primitiveInterfaces, ps, comm),
    obr_(obr)
{}
