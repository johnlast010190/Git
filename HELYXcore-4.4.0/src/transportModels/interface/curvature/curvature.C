...
(
    ...
    preSmoothCycles_(transpProp.subDict("curvature").lookup<scalar>("preSmoothCycles")),

    postSmoothCycles_(transpProp.subDict("curvature").lookup<scalar>("postSmoothCycles")),
