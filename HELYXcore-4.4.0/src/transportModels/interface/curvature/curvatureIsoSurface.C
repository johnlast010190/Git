...
#include "curvature/curvatureIsoSurface.H"
...
{
    // Calculate curvature
    calcK(); //    volScalarField kappa = - fvc::div(nHatfv_ & mesh_.Sf());

    // Smooth the curvature, distribute it near the interface and smooth again
