...
#include "curvature/curvatureSimple.H"
#include "db/runTimeSelection/construction/addToRunTimeSelectionTable.H"

namespace Foam
{

defineTypeNameAndDebug( curvatureSimple, 0 );
addToRunTimeSelectionTable( curvature, curvatureSimple, dictionary );

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::curvatureSimple::curvatureSimple
(
    const word& name,
...
void Foam::curvatureSimple::calculateK()
{
