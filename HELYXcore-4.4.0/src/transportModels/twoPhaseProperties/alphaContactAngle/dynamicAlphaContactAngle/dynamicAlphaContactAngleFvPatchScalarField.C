...
#include "alphaContactAngle/dynamicAlphaContactAngle/dynamicAlphaContactAngleFvPatchScalarField.H"
...
:
    ...
    thetaA_(dict.lookup<scalar>("thetaA")),
    thetaR_(dict.lookup<scalar>("thetaR"))
{
    evaluate();
}
