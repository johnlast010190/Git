...
:
    ...
    (
        ...
        (
            "cAlpha",
            dimless,
            alpha1.mesh().solution().solverDict
            (
                alpha1.name()
    ...
    (
        ...
        (
            alpha1.name()
        ).lookupOrDefault<word>("cAlphaModel", "constant")
    ),
    sigmaPtr_
    (
        surfaceTensionModels::surfaceTensionModel::New(dict, alpha1.mesh())
    ),
    deltaN_
    (
        "deltaN",
    ...
    (
        "alphaCoThreshold",
        alpha1.dimensions(),
        alpha1.mesh().time().controlDict().lookupOrDefault<scalar>
        (
            "alphaCoThreshold",
            0.05
        )
...
{
    scalar cAlpha =
        alpha1_.mesh().solution().solverDict(alpha1_.name()).lookup<scalar>
        (
            "cAlpha"
        );
    cAlpha_ = cAlpha;
    ...
    alphaCoThreshold_ =
        ...
        (
            "alphaCoThreshold",
            alpha1_.dimensions(),
            alpha1_.mesh().time().controlDict().lookupOrDefault<scalar>
            (
                "alphaCoThreshold",
                0.05
            )
