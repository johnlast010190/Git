...
Foam::tmp<Foam::volScalarField> Foam::incompressibleTwoPhaseMixture::rho() const
{
...
const Foam::volScalarField& Foam::incompressibleTwoPhaseMixture::Cp() const
{
    NotImplemented;
}
...
Foam::tmp<Foam::volScalarField>
Foam::incompressibleTwoPhaseMixture::lambda() const
{
    NotImplemented;
}


Foam::tmp<Foam::volScalarField> Foam::incompressibleTwoPhaseMixture::Prt() const
{
    NotImplemented;
}


Foam::tmp<Foam::volScalarField> Foam::incompressibleTwoPhaseMixture::Pr() const
{
    NotImplemented;
}
...
Foam::tmp<Foam::volScalarField>
Foam::incompressibleTwoPhaseMixture::alphaLam() const
{
    NotImplemented;
}
