...
:
    ...
    maxIterCoarsest_(defaultMaxIter_),
    relTolCoarsest_(relTol_),
    directSolveCoarsest_(false),
    solveForCorrection_(false),
    smoothSolveCoarsest_(false),
    nCoarsestSweeps_(50),
...
void Foam::GAMGSolver::readControls()
{
    ...
    controlDict_.readIfPresent("smoothSolveCoarsest", smoothSolveCoarsest_);
    controlDict_.readIfPresent("nCoarsestSweeps", nCoarsestSweeps_);
    maxIterCoarsest_ =
        controlDict_.lookupOrDefault<label>
        (
            "maxIterCoarsest", smoothSolveCoarsest_ ? 5 : defaultMaxIter_
        );
    relTolCoarsest_ =
        controlDict_.lookupOrDefault<scalar>("relTolCoarsest", relTol_);
    controlDict_.readIfPresent("directSolveCoarsest", directSolveCoarsest_);

    controlDict_.readIfPresent("solveForCorrection", solveForCorrection_);
    ...
    if (debug)
    {
        Pout<< "GAMGSolver settings :"
            ...
            << " solveForCorrection:" << solveForCorrection_
            << endl;
    }
}
