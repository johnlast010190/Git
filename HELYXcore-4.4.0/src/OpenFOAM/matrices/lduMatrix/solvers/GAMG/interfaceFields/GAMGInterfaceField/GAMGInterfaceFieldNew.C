...
)
{
    ...
    const auto ctor =
        ctorTableLookup
        (
            "GAMGInterfaceField type",
            lduInterfaceFieldConstructorTable_(),
            coupleType
        );
    return autoPtr<GAMGInterfaceField>(ctor(GAMGCp, fineInterface));
}
...
)
{
    ...
    return autoPtr<GAMGInterfaceField>(ctor(GAMGCp, rank));
}
