...
Foam::dimensionSet Foam::sign101(const dimensionSet&) //- dcombest 8/15/2012
{
    return dimless;
}

/*Foam::dimensionSet Foam::sign101(const dimensionSet&, const scalar&) //- dcombest 8/15/2012
{
    return dimless;
}
Foam::dimensionSet Foam::sign101(const dimensionSet&, const dimensionedScalar&) //- dcombest 8/15/2012
{
    return dimless;
}
Foam::dimensionSet Foam::sign101(const dimensionedScalar&, const dimensionSet&) //- dcombest 8/15/2012
{
    return dimless;
}*/
...
Foam::dimensionSet Foam::ptanh(const dimensionSet&)
{
    return dimless;
}
