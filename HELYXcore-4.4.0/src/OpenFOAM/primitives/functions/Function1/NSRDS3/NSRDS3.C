...
template<class Type>
Foam::Function1Types::NSRDS3<Type>::NSRDS3(const NSRDS3& poly)
:
    Function1<Type>(poly),
...
template<class Type>
void Foam::Function1Types::NSRDS3<Type>::convertTimeBase(const Time& t)
{
    NotImplemented;
}
...
template<class Type>
Type Foam::Function1Types::NSRDS3<Type>::value(const scalar x) const
{
...
template<class Type>
Type Foam::Function1Types::NSRDS3<Type>::integrate
(
    const scalar x1,
    const scalar x2
) const
...
template<class Type>
Type Foam::Function1Types::NSRDS3<Type>::integrateYoverX
(
    const scalar x1,
    const scalar x2
) const
...
template<class Type>
Type Foam::Function1Types::NSRDS3<Type>::derivative(const scalar x) const
{
