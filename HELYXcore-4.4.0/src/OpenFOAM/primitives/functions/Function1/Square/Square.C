...
template<class Type>
Type Foam::Function1Types::Square<Type>::derivative(const scalar t) const
{
    // Square function should be always locally constant.
    // Exept maybe corners that are not accounted for here.
