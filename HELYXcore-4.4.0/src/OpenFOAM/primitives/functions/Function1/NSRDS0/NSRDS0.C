...
template<class Type>
Foam::Function1Types::NSRDS0<Type>::NSRDS0(const NSRDS0& poly)
:
    Function1<Type>(poly),
...
template<class Type>
void Foam::Function1Types::NSRDS0<Type>::convertTimeBase(const Time& t)
{
    NotImplemented;
}
...
template<class Type>
Type Foam::Function1Types::NSRDS0<Type>::value(const scalar x) const
{
...
template<class Type>
Type Foam::Function1Types::NSRDS0<Type>::integrate
(
    const scalar x1,
    const scalar x2
) const
...
template<class Type>
Type Foam::Function1Types::NSRDS0<Type>::integrateYoverX
(
    const scalar x1,
    const scalar x2
) const
...
template<class Type>
Type Foam::Function1Types::NSRDS0<Type>::derivative(const scalar x) const
{
