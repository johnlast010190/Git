...
#include "primitives/functions/Function1/linearRamp/linearRamp.H"
...
Foam::scalar Foam::Function1Types::linearRamp::derivative(const scalar t) const
{
    return linearRampDerivative(t);
}
