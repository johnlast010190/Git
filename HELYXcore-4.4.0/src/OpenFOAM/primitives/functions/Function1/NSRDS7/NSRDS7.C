...
template<class Type>
Foam::Function1Types::NSRDS7<Type>::NSRDS7
(
...
template<class Type>
Foam::Function1Types::NSRDS7<Type>::NSRDS7(const NSRDS7& poly)
:
    Function1<Type>(poly),
...
template<class Type>
Type Foam::Function1Types::NSRDS7<Type>::sinhPart
(
    const scalar x
) const
{
...
template<class Type>
Type Foam::Function1Types::NSRDS7<Type>::coshPart
(
    const scalar x
) const
{
...
template<class Type>
void Foam::Function1Types::NSRDS7<Type>::convertTimeBase(const Time& t)
{
    NotImplemented;
}
...
template<class Type>
Type Foam::Function1Types::NSRDS7<Type>::value(const scalar x) const
{
...
template<class Type>
Type Foam::Function1Types::NSRDS7<Type>::integrate
(
    const scalar x1,
    const scalar x2
) const
...
template<class Type>
Type Foam::Function1Types::NSRDS7<Type>::integrateYoverX
(
    const scalar x1,
    const scalar x2
) const
...
template<class Type>
Type Foam::Function1Types::NSRDS7<Type>::derivative(const scalar x) const
{
...
template<class Type>
void Foam::Function1Types::NSRDS7<Type>::writeData(Ostream& os) const
{
