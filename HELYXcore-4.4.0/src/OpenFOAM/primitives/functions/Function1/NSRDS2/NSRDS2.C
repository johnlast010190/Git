...
template<class Type>
Foam::Function1Types::NSRDS2<Type>::NSRDS2
(
...
template<class Type>
Foam::Function1Types::NSRDS2<Type>::NSRDS2(const NSRDS2& poly)
:
    Function1<Type>(poly),
...
template<class Type>
void Foam::Function1Types::NSRDS2<Type>::convertTimeBase(const Time& t)
{
    NotImplemented;
}
...
template<class Type>
Type Foam::Function1Types::NSRDS2<Type>::value(const scalar x) const
{
...
template<class Type>
Type Foam::Function1Types::NSRDS2<Type>::integrate
(
    const scalar x1,
    const scalar x2
) const
...
template<class Type>
Type Foam::Function1Types::NSRDS2<Type>::integrateYoverX
(
    const scalar x1,
    const scalar x2
) const
...
template<class Type>
Type Foam::Function1Types::NSRDS2<Type>::derivative(const scalar x) const
{
...
template<class Type>
void Foam::Function1Types::NSRDS2<Type>::writeData(Ostream& os) const
{
