...
template<class Type>
Foam::Function1Types::NSRDS6<Type>::NSRDS6
(
...
template<class Type>
Foam::Function1Types::NSRDS6<Type>::NSRDS6(const NSRDS6& poly)
:
    Function1<Type>(poly),
    Tc_(poly.Tc_),
...
template<class Type>
Type Foam::Function1Types::NSRDS6<Type>::exponent
(
    const scalar x
) const
{
...
template<class Type>
Type Foam::Function1Types::NSRDS6<Type>::exponentDerivative
(
    const scalar x
) const
{
...
template<class Type>
void Foam::Function1Types::NSRDS6<Type>::convertTimeBase(const Time& t)
{
    NotImplemented;
}
...
template<class Type>
Type Foam::Function1Types::NSRDS6<Type>::value(const scalar x) const
{
...
template<class Type>
Type Foam::Function1Types::NSRDS6<Type>::integrate
(
    const scalar x1,
    const scalar x2
) const
...
template<class Type>
Type Foam::Function1Types::NSRDS6<Type>::integrateYoverX
(
    const scalar x1,
    const scalar x2
) const
...
template<class Type>
Type Foam::Function1Types::NSRDS6<Type>::derivative(const scalar x) const
{
...
template<class Type>
void Foam::Function1Types::NSRDS6<Type>::writeData(Ostream& os) const
{
