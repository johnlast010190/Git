...
template<class Type>
Foam::Function1Types::NSRDS4<Type>::NSRDS4
(
...
template<class Type>
Foam::Function1Types::NSRDS4<Type>::NSRDS4(const NSRDS4& poly)
:
    Function1<Type>(poly),
...
template<class Type>
Type Foam::Function1Types::NSRDS4<Type>::indefiniteIntegral
(
    const scalar x
) const
{
...
template<class Type>
Type Foam::Function1Types::NSRDS4<Type>::indefiniteIntegralYoverX
(
    const scalar x
) const
{
...
template<class Type>
void Foam::Function1Types::NSRDS4<Type>::convertTimeBase(const Time& t)
{
    NotImplemented;
}
...
template<class Type>
Type Foam::Function1Types::NSRDS4<Type>::value(const scalar x) const
{
...
template<class Type>
Type Foam::Function1Types::NSRDS4<Type>::integrate
(
    const scalar x1,
    const scalar x2
) const
...
template<class Type>
Type Foam::Function1Types::NSRDS4<Type>::integrateYoverX
(
    const scalar x1,
    const scalar x2
) const
...
template<class Type>
Type Foam::Function1Types::NSRDS4<Type>::derivative(const scalar x) const
{
...
template<class Type>
void Foam::Function1Types::NSRDS4<Type>::writeData(Ostream& os) const
{
