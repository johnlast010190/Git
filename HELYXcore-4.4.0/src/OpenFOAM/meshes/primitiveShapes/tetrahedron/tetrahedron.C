...
) const
{
    ...
    pointHit pHit(circumSphere().first());
    pHit.setHit();
    ...
    {
        point ctr = triPointRef(a_, b_, c_).circumCircle().first();
    ...
    {
        point ctr = triPointRef(a_, b_, d_).circumCircle().first();
        scalar radiusSqr = magSqr(ctr - a_);
    ...
    {
        point ctr = triPointRef(a_, c_, d_).circumCircle().first();
        scalar radiusSqr = magSqr(ctr - a_);
    ...
    {
        point ctr = triPointRef(b_, c_, d_).circumCircle().first();
