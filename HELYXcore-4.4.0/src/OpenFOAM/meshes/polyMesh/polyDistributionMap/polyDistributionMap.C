...
:
    ...
    oldPatchSizes_(std::move(map.oldPatchSizes_)),
    oldPatchStarts_(std::move(map.oldPatchStarts_)),
    oldPatchNMeshPoints_(std::move(map.oldPatchNMeshPoints_)),
    pointMap_(std::move(map.pointMap_)),
    faceMap_(std::move(map.faceMap_)),
    cellMap_(std::move(map.cellMap_)),
    patchMap_(std::move(map.patchMap_))
{}
...
void Foam::polyDistributionMap::operator=(const polyDistributionMap& rhs)
{
    nOldPoints_ = rhs.nOldPoints_;
    nOldFaces_ = rhs.nOldFaces_;
    nOldCells_ = rhs.nOldCells_;
...
void Foam::polyDistributionMap::operator=(polyDistributionMap&& rhs)
{
    ...
    nOldFaces_ = rhs.nOldFaces_;
    nOldCells_ = rhs.nOldCells_;
    oldPatchSizes_ = std::move(rhs.oldPatchSizes_);
    oldPatchStarts_ = std::move(rhs.oldPatchStarts_);
    oldPatchNMeshPoints_ = std::move(rhs.oldPatchNMeshPoints_);
    pointMap_ = std::move(rhs.pointMap_);
    faceMap_ = std::move(rhs.faceMap_);
    cellMap_ = std::move(rhs.cellMap_);
    patchMap_ = std::move(rhs.patchMap_);
}
