...
#include "meshes/polyMesh/polyPatches/basic/generic/genericPolyPatch.H"
...
namespace Foam
{
    ...
    addToRunTimeSelectionTable(directPolyPatch, genericPolyPatch, word);
    addToRunTimeSelectionTable(directPolyPatch, genericPolyPatch, dictionary);
}
