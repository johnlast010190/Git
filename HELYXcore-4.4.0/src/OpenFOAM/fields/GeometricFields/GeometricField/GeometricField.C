...
{
    return
        New(name, mesh.thisDb(), mesh, ds, patchFieldType, actualPatchTypes);
}
...
{
    return
        New(name, mesh.thisDb(), mesh, dt, patchFieldType, actualPatchTypes);
}
...
{
    return
        New(name, mesh.thisDb(), mesh, dt, patchFieldTypes, actualPatchTypes);
}
