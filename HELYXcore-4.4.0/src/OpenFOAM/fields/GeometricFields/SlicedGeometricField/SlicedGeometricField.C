...
)
{
    ...
    forAll(mesh.boundary(), patchi)
    {
        ...
        {
            if (isA<directPolyPatch>(mesh.boundaryMesh()[patchi]))
            {
                bf.set
                (
                    patchi,
            ...
            else
            {
                ...
                bf[patchi].List<Type>::operator=
                (
                    mesh.boundary()[patchi].patch().indirectPatchSlice
                    (
                        completeField
                    )
                );
...
)
{
    ...
    forAll(mesh.boundary(), patchi)
    {
        if (preserveCouples && mesh.boundary()[patchi].coupled())
        {
            ...
            // Assign field
            bf[patchi].forceAssign(bField[patchi]);
        }
        else
        {
            if (isA<directPolyPatch>(mesh.boundary()[patchi]))
            {
            ...
            else
            {
                ...
                bf[patchi].List<Type>::operator=(bField[patchi]);
            }
        }
    }
    ...
    forAll(mesh.boundaryMesh(), patchi)
    {
        ...
        else
        {
            ...
            (
                ...
                mesh.boundaryMesh()[patchi].size(),
                start
            ) = Field<Type>(mesh.boundaryMesh()[patchi].size(), Zero);
        }
