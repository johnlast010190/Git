...
Foam::DecoupledCoeffField<Type>::transpose() const
{
    ...
    DecoupledCoeffField<Type>& t = tt.ref();
...
template<class Type>
const typename Foam::DecoupledCoeffField<Type>::squareTypeField&
Foam::DecoupledCoeffField<Type>::asSquare() const
{
    if (!squareCoeffPtr_)
    {
        FatalErrorInFunction
...
template<class Type>
typename Foam::DecoupledCoeffField<Type>::squareTypeField&
Foam::DecoupledCoeffField<Type>::asSquare()
{
    if (!squareCoeffPtr_)
    {
        FatalErrorInFunction
...
#include "fields/CoeffField/DecoupledCoeffFieldFunctions.C"
