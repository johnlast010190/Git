...
#ifdef HELYX_USE_OPENCASCADE
  #include "distributedCADSurface/distributedCADSurface.H"
#endif


void Foam::helyxVDB::voxelize
(
...
)
{
    ...
    const scalar level0Edge = voxelSize_ * (1 << maxCellLevel_);
    ...
    { Timer timer("wait for other procs");
        ...
        wait[Pstream::myProcNo()] = labelList(label(1), Pstream::myProcNo());
