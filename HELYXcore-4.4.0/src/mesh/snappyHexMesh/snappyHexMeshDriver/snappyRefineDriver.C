...
//        meshRefiner_.intersectedFaces(),
    ...
    // Create marker field to identify only modified cells
    meshRefiner_.createModifiedCellMarker();
    ...
    meshRefiner_.clearModifiedCellMarker();
...
)
{
    ...
    //Setup list of modified cells to speed-up proximity refinement iteration
    meshRefiner_.createModifiedCellMarker();
...
*/
        ...
        {
            //Refine cells
            autoPtr<polyTopoChangeMap> map = meshRefiner_.refine
            (
                cellsToRefine,
...
)
{
    ...
    meshRefiner_.mergeCouples(refineParams);
...
)
{
    ...
    if (refineParams.surfaceRefineRemoval())
    {
        // Remove cells (a certain distance) beyond surface intersections
        removeInsideCells
        (
    ...
    // Optional surface/proximity refinement after shell refinement
    if (refineParams.finalSurfaceRefine())
    {
        // Refine based on surface
        surfaceOnlyRefine
        (
...
)
{
    ...
    helyxVDB vdb(voxelSize, maxLevel);
