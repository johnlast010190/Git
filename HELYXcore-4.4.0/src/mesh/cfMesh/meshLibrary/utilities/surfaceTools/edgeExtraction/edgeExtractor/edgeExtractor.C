...
#include "utilities/surfaceTools/meshSurfaceEngine/meshSurfaceEngineModifier.H"
...
#include "utilities/helperClasses/parallelHelpers/labelledScalar/labelledScalar.H"
#include "utilities/helperClasses/parallelHelpers/labelledPoint/labelledPoint.H"
#include "utilities/helperClasses/parallelHelpers/labelledPoint/refLabelledPoint.H"
#include "containers/HashTables/HashSet/HashSet.H"
#include "utilities/triSurfaceTools/triSurfacePartitioner/triSurfacePartitioner.H"
#include "utilities/triSurfaceTools/triSurfaceClassifyEdges/triSurfaceClassifyEdges.H"
#include "utilities/surfaceTools/meshSurfaceMapper/meshSurfaceMapper.H"
#include "utilities/surfaceTools/meshSurfaceCheckInvertedVertices/meshSurfaceCheckInvertedVertices.H"
    ...
    forAll(bPoints, bpI)
    {
        ...
        else
        {
            ...
            FatalErrorInFunction
                ...
                << " into any surface patch!. Exiting.."
                << exit(FatalError);
        }
    }
...
void edgeExtractor::topoChangePatches()
{
    const triSurf& surface = meshOctree_.surface();
