...
#include "utilities/anisotropicMeshing/coordinateModification/planeScaling.H"
...
void planeScaling::operator=(const dictionary& d)
{
    ...
    scalingDistance_ = dict.lookup<scalar>("scalingDistance");

    // Specify scaling factor
    scalingFactor_ = dict.lookup<scalar>("scalingFactor");
}
