...
#include "utilities/octrees/meshOctree/refinementControls/objectRefinement/coneRefinement.H"
...
void coneRefinement::writeDict(Ostream& os, bool subDict) const
{
    ...
    os.writeEntry("radius0", r0_);
    os.writeEntry("p1", p1_);
    os.writeEntry("radius1", r1_);
...
void coneRefinement::operator=(const dictionary& d)
{
    ...
    p0_ = dict.lookup<vector>("p0");
    r0_ = dict.lookup<scalar>("radius0");
    p1_ = dict.lookup<point>("p1");
    r1_ = dict.lookup<scalar>("radius1");
}
