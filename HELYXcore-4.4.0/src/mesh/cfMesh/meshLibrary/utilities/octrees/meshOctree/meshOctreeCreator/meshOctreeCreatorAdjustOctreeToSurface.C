...
#include "utilities/octrees/meshOctree/refinementControls/objectRefinement/objectRefinementList.H"
...
#include "utilities/anisotropicMeshing/coordinateModification/coordinateModifier.H"
...
void meshOctreeCreator::refineBoxesContainedInObjects()
{
    ...
    const scalar s(meshDictPtr_->lookup<scalar>("maxCellSize"));
...
void meshOctreeCreator::refineBoxesIntersectingSurfaces()
{
    ...
    forAll(surfaces, surfI)
    {
        ...
        {
            scalar s(meshDictPtr_->lookup<scalar>("maxCellSize"));
