...
#include "utilities/smoothers/geometry/meshOptimizer/tetMeshOptimisation/advancedSmoothers/knuppMetric/knuppMetric.H"
    ...
    do
    {
        ...
        # endif
        {
            ...
            forAll(smoothVertex, nodeI)
            {
                ...
                (
                    !negativeNode[nodeI] ||
                    (smoothVertex[nodeI] & partTetMesh::LOCKED)
                )
                    continue;
