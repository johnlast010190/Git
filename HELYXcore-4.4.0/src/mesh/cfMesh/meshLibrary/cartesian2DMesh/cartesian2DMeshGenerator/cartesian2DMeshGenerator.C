...
#include "cartesian2DMesh/cartesian2DMeshGenerator/cartesian2DMeshGenerator.H"
...
#include "utilities/triSurfaceTools/triSurfaceCleanupDuplicateTriangles/triSurfaceCleanupDuplicateTriangles.H"
...
#include "utilities/surfaceTools/meshSurfaceEdgeExtractor2D/meshSurfaceEdgeExtractor2D.H"
...
#include "utilities/surfaceTools/renameBoundaryPatches/renameBoundaryPatches.H"
...
#include "utilities/smoothers/topology/checkIrregularSurfaceConnections/checkIrregularSurfaceConnections.H"
#include "utilities/smoothers/topology/checkNonMappableCellConnections/checkNonMappableCellConnections.H"
#include "utilities/smoothers/topology/checkBoundaryFacesSharingTwoEdges/checkBoundaryFacesSharingTwoEdges.H"
#include "utilities/triSurfaceTools/triSurfaceMetaData/triSurfaceMetaData.H"
...
void cartesian2DMeshGenerator::createCartesianMesh()
{
    ...
    {
        if (meshDict_.lookup<bool>("decomposePolyhedraIntoTetsAndPyrs"))
