...
#include "meshDistribute/meshDistribute.H"
...
namespace Foam
{
    defineTypeNameAndDebug(meshDistribute, 0);
...
void Foam::meshDistribute::inplaceRenumberWithFlip
(
...
Foam::labelList Foam::meshDistribute::select
(
...
Foam::wordList Foam::meshDistribute::fieldNames(const word& typeName) const
{
...
void Foam::meshDistribute::checkEqualWordList
(
    const word& typeName,
    const wordList& lst
)
...
Foam::wordList Foam::meshDistribute::mergeWordList(const wordList& procNames)
{
    List<wordList> allNames(Pstream::nProcs());
...
void Foam::meshDistribute::printMeshInfo(const fvMesh& mesh)
{
...
void Foam::meshDistribute::printCoupleInfo
(
...
Foam::label Foam::meshDistribute::findInternalPatch() const
{
...
Foam::tmp<Foam::surfaceScalarField> Foam::meshDistribute::generateTestField
(
    const fvMesh& mesh
)
{
...
void Foam::meshDistribute::testField(const surfaceScalarField& fld)
{
...
Foam::autoPtr<Foam::polyTopoChangeMap> Foam::meshDistribute::deleteProcPatches
(
...
//            nProcPatches++;
    ...
    autoPtr<polyTopoChangeMap> map = repatch(newPatchID, mesh_, dummyFaceMaps);
...
Foam::autoPtr<Foam::polyTopoChangeMap> Foam::meshDistribute::repatch
(
...
)
{
    ...
    saveBoundaryFields<scalar, surfaceMesh>(sFields, mesh);
    PtrList<FieldField<fvsPatchField, vector>> vFields;
    saveBoundaryFields<vector, surfaceMesh>(vFields, mesh);
    PtrList<FieldField<fvsPatchField, sphericalTensor>> sptFields;
    saveBoundaryFields<sphericalTensor, surfaceMesh>(sptFields, mesh);
    PtrList<FieldField<fvsPatchField, symmTensor>> sytFields;
    saveBoundaryFields<symmTensor, surfaceMesh>(sytFields, mesh);
    PtrList<FieldField<fvsPatchField, tensor>> tFields;
    saveBoundaryFields<tensor, surfaceMesh>(tFields, mesh);
    ...
    autoPtr<polyTopoChangeMap> map = meshMod.changeMesh(mesh, false, syncPar);
    ...
    mapBoundaryFields<scalar, surfaceMesh>(map, sFields, mesh);
    mapBoundaryFields<vector, surfaceMesh>(map, vFields, mesh);
    mapBoundaryFields<sphericalTensor, surfaceMesh>(map, sptFields, mesh);
    mapBoundaryFields<symmTensor, surfaceMesh>(map, sytFields, mesh);
    mapBoundaryFields<tensor, surfaceMesh>(map, tFields, mesh);
...
// merge those points.
Foam::autoPtr<Foam::polyTopoChangeMap> Foam::meshDistribute::mergeSharedPoints
(
...
)
{
    ...
    meshAdder::mergePoints(mesh, pointToMaster, meshMod);
...
void Foam::meshDistribute::getCouplingData
(
...
void Foam::meshDistribute::subsetCouplingData
(
    const fvMesh& mesh,
...
void Foam::meshDistribute::findCouples
(
    const primitiveMesh& mesh,
    const labelList& sourceFace,
    const labelList& sourceProc,
...
Foam::labelList Foam::meshDistribute::mapBoundaryData
(
...
Foam::labelList Foam::meshDistribute::mapPointData
(
    const primitiveMesh& mesh,      // mesh after adding
    const mapAddedPolyMesh& map,
    const labelList& boundaryData0, // on mesh before adding
...
Foam::autoPtr<Foam::polyTopoChangeMap> Foam::meshDistribute::doRemoveCells
(
...
)
{
    ...
    saveInternalFields(sFields);
    PtrList<Field<vector>> vFields;
    saveInternalFields(vFields);
    PtrList<Field<sphericalTensor>> sptFields;
    saveInternalFields(sptFields);
    PtrList<Field<symmTensor>> sytFields;
    saveInternalFields(sytFields);
    PtrList<Field<tensor>> tFields;
    saveInternalFields(tFields);
...
void Foam::meshDistribute::mapFields(fvMesh& mesh, const polyTopoChangeMap& map)
{
    meshObject::topoChange<polyMesh>(mesh, map);
    meshObject::topoChange<pointMesh>(mesh, map);
    mesh.mapFields(map);
    meshObject::topoChange<fvMesh>(mesh, map);
    meshObject::topoChange<lduMesh>(mesh, map);
}


// Delete and add processor patches. Changes mesh and returns per neighbour proc
// the processor patchID.
void Foam::meshDistribute::addProcPatches
(
...
void Foam::meshDistribute::addNccProcPatches
(
...
Foam::meshDistribute::procPolyFaceAddr
(
...
void Foam::meshDistribute::unconform
(
    PtrList<fvMesh>& myProcMeshes,
    const List<labelList>& meshNoInProc,
    const PtrList<polyDistributionMap>& distMaps,
    const surfaceLabelField::Boundary origPolyFacesBf,
    const labelList& origFaceOwner,
    const labelList& cellToProc
)
...
Foam::labelList Foam::meshDistribute::getBoundaryPatch
(
...
void Foam::meshDistribute::sendMesh
(
    const label domain,
    const fvMesh& mesh,
...
Foam::autoPtr<Foam::fvMesh> Foam::meshDistribute::receiveMesh
(
    const label domain,
    const wordList& pointZoneNames,
    const wordList& faceZoneNames,
...
Foam::label Foam::meshDistribute::getRotation
(
...
void Foam::meshDistribute::reorderCoupledFaces
(
    PtrList<fvMesh>& myProcMeshes,
...
Foam::meshDistribute::meshDistribute(fvMesh& mesh, const scalar mergeTol)
:
    mesh_(mesh),
    mergeTol_(mergeTol),
    nFinalProcs_(Pstream::nProcs())
...
Foam::labelList Foam::meshDistribute::countCells
(
    const labelList& distribution
)
{
...
void Foam::meshDistribute::receiveAllFieldsImpl
(
...
void Foam::meshDistribute::receiveAllFields
(
    const label sendProc,
    fvMesh& domainMesh,
    const dictionary& fieldDicts,
...
Foam::labelListList Foam::meshDistribute::calcMeshToProcMap
(
    const label nFinalProcs,
...
void Foam::meshDistribute::setNFinalProcs
(
...
void Foam::meshDistribute::initMeshList
(
    ...
    List<PtrList<volSymmTensorField>>& volSymmTensorFields,
    List<PtrList<surfaceScalarField>>& surfaceScalarFields
)
{
    bool oldParRun = UPstream::parRun();
    UPstream::parRun() = false;
...
Foam::autoPtr<Foam::polyDistributionMap> Foam::meshDistribute::distribute
(
    const labelList& distribution,
    PtrList<fvMesh>& myProcMeshes, /*= dummyMeshList*/
    PtrList<polyDistributionMap>& mapsDist /*= dummyMapList*/
)
{
    ...
    (
        fieldNames(volScalarField::typeName)
    );
    const wordList volVectors
    (
        fieldNames(volVectorField::typeName)
    );
    const wordList volSphereTensors
    (
        fieldNames(volSphericalTensorField::typeName)
    );
    ...
    (
        fieldNames(volTensorField::typeName)
    );
    const wordList volVectors1
    (
        fieldNames(volVector1Field::typeName)
    );
    const wordList volVectors4
    (
        fieldNames(volVector4Field::typeName)
    );
    const wordList volTensors4
    (
        fieldNames(volTensor4Field::typeName)
    );

    const wordList surfScalars
    (
        fieldNames(surfaceScalarField::typeName)
    );
    const wordList surfVectors
    (
        fieldNames(surfaceVectorField::typeName)
    );
    const wordList surfSphereTensors
    (
        fieldNames(surfaceSphericalTensorField::typeName)
    );
    const wordList surfSymmTensors
    (
        fieldNames(surfaceSymmTensorField::typeName)
    );
    const wordList surfTensors
    (
        fieldNames(surfaceTensorField::typeName)
    );

    const wordList pointScalars
    (
        fieldNames(pointScalarField::typeName)
    );
    const wordList pointVectors
    (
        fieldNames(pointVectorField::typeName)
    );
    const wordList pointSphereTensors
    (
        fieldNames(pointSphericalTensorField::typeName)
    );
    const wordList pointSymmTensors
    (
        fieldNames(pointSymmTensorField::typeName)
    );
    const wordList pointTensors
    (
        fieldNames(pointTensorField::typeName)
    );

    const wordList dimScalars
    (
        fieldNames(volScalarField::Internal::typeName)
    );
    const wordList dimVectors
    (
        fieldNames(volVectorField::Internal::typeName)
    );
    const wordList dimSphereTensors
    (
        fieldNames(volSphericalTensorField::Internal::typeName)
    );
    const wordList dimSymmTensors
    (
        fieldNames(volSymmTensorField::Internal::typeName)
    );
    const wordList dimTensors
    (
        fieldNames(volTensorField::Internal::typeName)
    );

    const wordList dimVectors1
    (
        fieldNames(volVector1Field::Internal::typeName)
    );
    const wordList dimVectors4
    (
        fieldNames(volVector4Field::Internal::typeName)
    );
    const wordList dimTensors4
    (
        fieldNames(volTensor4Field::Internal::typeName)
    );
    ...
    {
        autoPtr<polyTopoChangeMap> repatchMap = deleteProcPatches(oldInternalPatchi);
    ...
    if (nFinalProcs_ > Pstream::nProcs())
    {
        ...
        forAll(nSendCells[myProcNo], recvMesh)
        {
            if (nSendCells[myProcNo][recvMesh] > 0)
            {
                ...
                if (recvProc != myProcNo)
                {
                    ...
                    // pointFields
                    sendFields<pointScalarField>(recvProc, pointScalars, subsetter, str);
                    sendFields<pointVectorField>(recvProc, pointVectors, subsetter, str);
                    sendFields<pointSphericalTensorField>(recvProc, pointSphereTensors, subsetter, str);
                    sendFields<pointSymmTensorField>(recvProc, pointSymmTensors, subsetter, str);
                    sendFields<pointTensorField>(recvProc, pointTensors, subsetter, str);
                }
                else
                {
                    if (debug)
                    ...
                    // pointFields
                    sendFields<pointScalarField>(recvProc, pointScalars, subsetter, fieldStr[nStr]);
                    sendFields<pointVectorField>(recvProc, pointVectors, subsetter, fieldStr[nStr]);
                    sendFields<pointSphericalTensorField>(recvProc, pointSphereTensors, subsetter, fieldStr[nStr]);
                    sendFields<pointSymmTensorField>(recvProc, pointSymmTensors, subsetter, fieldStr[nStr]);
                    sendFields<pointTensorField>(recvProc, pointTensors, subsetter, fieldStr[nStr]);
        ...
        forAll(nSendCells, sendProc)
        {
            ...
            for (label i = 0; i < nMyMeshes; i++)
            {
...

                {
                    ...
                    // Manually receive point fields
                    pointMesh& domainPointMesh =
                        const_cast<pointMesh&>(pointMesh::New(domainMesh));
                    receiveFields<pointScalarField>(sendProc, pointScalars, domainPointMesh, psf, fieldDicts.subDict(pointScalarField::typeName));
                    receiveFields<pointVectorField>(sendProc, pointVectors, domainPointMesh, pvf, fieldDicts.subDict(pointVectorField::typeName));
                    receiveFields<pointSphericalTensorField>(sendProc, pointSphereTensors, domainPointMesh, psptf, fieldDicts.subDict(pointSphericalTensorField::typeName));
                    receiveFields<pointSymmTensorField>(sendProc, pointSymmTensors, domainPointMesh, psytf, fieldDicts.subDict(pointSymmTensorField::typeName));
                    receiveFields<pointTensorField>(sendProc, pointTensors, domainPointMesh, ptf, fieldDicts.subDict(pointTensorField::typeName));
                }
        ...
        forAll(myProcMeshes, i)
        {
            ...
            autoPtr<polyDistributionMap> mapPtr
            (
                new polyDistributionMap
                (
                    mesh,
                    ...
                    (i > 0 ? 0 : nOldFaces),
                    (i > 0 ? 0 : nOldCells),
                    (i > 0 ? std::move(emptyList) : std::move(oldPatchStarts)),
                    (i > 0 ? std::move(emptyList) : std::move(oldPatchNMeshPoints)),

                    std::move(subPointMaps[i]),
                    std::move(subFaceMaps[i]),
                    std::move(subCellMaps[i]),
                    std::move(subPatchMaps[i]),
                    std::move(constructPointMaps[i]),
                    std::move(constructFaceMaps[i]),
                    std::move(constructCellMaps[i]),
                    std::move(constructPatchMaps[i]),
        ...
        // reset mesh_
        {
            ...
            labelList patchStarts(boundary.size(), 0);
    ...
    else // standard behaviour where every proc has one mesh
    {
        ...
        forAll(nSendCells, sendProc)
        {
            ...
            )
            {
                ...
                autoPtr<mapAddedPolyMesh> map = meshAdder::add
                (
                    mesh_,
                    domainMesh,
                    couples,
        ...
        if (!origMeshConformal)
        {
            ...
            return autoPtr<polyDistributionMap>(mapsDist.set(0, nullptr));
        }
