    ...
    displacementMotionSolverPtr_()
{
    ...
    pointVectorField points0(pointsMotionSolver::readPoints0(mesh));
...
void Foam::velocityDisplacementMotionSolver::topoChange
(
...
)
{
    ...
    displacementMotionSolverPtr_->topoChange(map);
}
