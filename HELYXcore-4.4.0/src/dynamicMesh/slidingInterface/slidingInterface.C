...
void Foam::slidingInterface::checkDefinition()
{
    ...
    )
    {
        FatalErrorInFunction
            ...
            << "masterFaceZoneID: " << masterFaceZoneID_ << ", active: "
            << masterFaceZoneID_.active() << nl
            << "slaveFaceZoneID: " << slaveFaceZoneID_ << ", active: "
            << slaveFaceZoneID_.active() << nl

            << "cutPointZoneID: " << cutPointZoneID_ << ", active: "
            << cutPointZoneID_.active() << nl
            << "cutFaceZoneID: " << cutFaceZoneID_ << ", active: "
            << cutFaceZoneID_.active() << nl

            << "masterPatchID: " << masterPatchID_ << ", active: "
            << masterPatchID_.active() << nl
            << "slavePatchID: " << slavePatchID_ << ", active: "
            << slavePatchID_.active() << nl
    ...
    {
        FatalErrorInFunction
            << "Please check your mesh definition." << nl
