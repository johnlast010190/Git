...
template<class Type>
void Foam::motionSmootherAlgo::checkConstraints(PointField<Type>& pf)
{
    typedef PointField<Type> FldType;
...
template<class Type>
Foam::tmp<Foam::PointField<Type>> Foam::motionSmootherAlgo::avg
(
