...
#include "patchToPatch/inverseDistance/inverseDistancePatchToPatch.H"
...
)
{
    ...
    forAll(srcWeights_, srcFacei)
    {
        ...
        {
            srcWeights_[srcFacei][i] /= max(w, patchToPatch::vSmall);
        }
    }
    ...
    forAll(tgtWeights_, tgtFacei)
    {
        ...
        {
            tgtWeights_[tgtFacei][i] /= max(w, patchToPatch::vSmall);
        }
    }
