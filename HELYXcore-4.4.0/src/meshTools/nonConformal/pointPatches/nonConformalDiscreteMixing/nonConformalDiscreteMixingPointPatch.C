...
namespace Foam
{
    defineTypeNameAndDebug(nonConformalDiscreteMixingPointPatch, 0);
...
void Foam::nonConformalDiscreteMixingPointPatch::initTopoChange
(
...
void Foam::nonConformalDiscreteMixingPointPatch::topoChange
(
    PstreamBuffers& pBufs
)
{
...
Foam::nonConformalDiscreteMixingPointPatch::nonConformalDiscreteMixingPointPatch
(
