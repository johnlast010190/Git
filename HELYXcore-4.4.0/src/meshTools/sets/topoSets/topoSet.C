...
)
{
    ...
    return autoPtr<topoSet>(ctor(mesh, name, r, w));
}
...
)
{
    const auto ctor =
        ...
        (
            "set type",
            sizeConstructorTable_(),
            setType
        );
    return autoPtr<topoSet>(ctor(mesh, name, size, w));
}
...
)
{
    const auto ctor =
        ...
        (
            "set type",
            setConstructorTable_(),
            setType
        );
    return autoPtr<topoSet>(ctor(mesh, name, set, w));
}
...
Foam::topoSet& Foam::topoSet::operator=(const topoSet& rhs)
{
    labelHashSet::operator=(rhs);
    return *this;
}

Foam::topoSet& Foam::topoSet::operator=(topoSet&& rhs) noexcept
{
    labelHashSet::operator=(rhs);
    return *this;
}

Foam::topoSet& Foam::topoSet::operator=(const labelHashSet& rhs)
{
    labelHashSet::operator=(rhs);
    return *this;
}

Foam::topoSet& Foam::topoSet::operator=(labelHashSet&& rhs) noexcept
{
    labelHashSet::operator=(rhs);
    return *this;
}
