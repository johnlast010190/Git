...
{
    return autoPtr<strainRateLaw>(new strainRateLaw(*this));
}
...
{
    castMaterial(modelName, strainRate)
...
Foam::scalar Foam::strainRateLaw::strainRateValue(scalar p, scalar T) const
{
    NotImplemented;
}
