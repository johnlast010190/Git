...
Foam::scalar
Foam::clippedWeightedAverageMixture::clippedWeightedAverageMixtureValue
(
    scalar p,
    scalar T
) const
...
Foam::vector
Foam::clippedWeightedAverageMixture::vectorClippedWeightedAverageMixtureValue
(
    scalar p,
    scalar T
) const
...
Foam::tensor
Foam::clippedWeightedAverageMixture::tensorClippedWeightedAverageMixtureValue
(
    scalar p,
    scalar T
) const
