...
Foam::scalar Foam::weightedAverageMixture::weightedAverageMixtureValue
(
    scalar p,
    scalar T
) const
...
Foam::vector Foam::weightedAverageMixture::vectorWeightedAverageMixtureValue
(
    scalar p,
    scalar T
) const
...
Foam::tensor Foam::weightedAverageMixture::tensorWeightedAverageMixtureValue
(
    scalar p,
    scalar T
) const
