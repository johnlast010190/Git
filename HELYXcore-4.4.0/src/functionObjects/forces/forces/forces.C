...
void Foam::functionObjects::forces::resetFields()
{
    ...
    if (writeFields_)
    {
        ...
        moment.forceAssign(dimensionedVector(moment.dimensions(), Zero));
    }
}
...
Foam::functionObjects::forces::bDevRhoReff() const
{
...
Foam::tmp<Foam::volSymmTensorField::Boundary>
Foam::functionObjects::forces::cachedBDevRhoReff() const
{
    typedef compressible::turbulenceModel cmpTurbModel;
    ...
    if (devRhoReffCachingActive_)
    {
        ...
        if (!cachedFieldPtr)
        {
            ...
            if (debug)
            {
                Info<< "forces: Calculated and stored devRhoReff field"
                    << endl;
            }
        }
        else
        {
            if (debug)
            {
                Info<< "forces: Used cached devRhoReff field" << endl;
            }
        }
    ...
    else
    {
        if (debug)
        {
            Info<< "forces: Calculating devRhoReff field" << endl;
        }
        return
            tmp<volSymmTensorField::Boundary>
            (
...
void Foam::functionObjects::forces::timeIncremented()
{
    ...
    if (devRhoReffCachingActive_)
    {
        ...
        if (cachedFieldPtr)
        {
            ...
            if (debug)
            {
                Info<< "forces: Cleared cached devRhoReff field" << endl;
            }
        }
    }
}
