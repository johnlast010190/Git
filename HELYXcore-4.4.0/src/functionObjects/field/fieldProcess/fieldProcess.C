...
template<>
const char* Foam::NamedEnum<Foam::functionObjects::fieldProcess::calcTypes, 47>::names[] =
{
    "none",
    "ptot",
    "Cp",
    ...
    "Urel",
    "Urtz",
    "UCartesianToCylindrical",
    "UCylindricalToCartesian",
    "wallHeatFlux",
    "Mach",
    "skinFriction",
...
const Foam::NamedEnum<Foam::functionObjects::fieldProcess::calcTypes, 47>
    ...
    forAll(operations_, opI)
    {
        ...
        switch(calcTypeNames_.read(IStringStream(operation)()))
        {
            ...
            case ctyPlus:
                yPlus(opDict);
            break;
            case ctFrictionVelocity:
                frictionVelocity(opDict);
            break;
            case ctmag:
                magOp(opDict);
            break;
            ...
            case ctUrtz:
                Urtz(opDict);
            break;
            case ctUCartesianToCylindrical:
                UCartesianToCylindrical(opDict);
            break;
            case ctUCylindricalToCartesian:
                UCylindricalToCartesian(opDict);
            break;
            case ctHeatFlux:
                wallHeatFlux(opDict);
            break;
