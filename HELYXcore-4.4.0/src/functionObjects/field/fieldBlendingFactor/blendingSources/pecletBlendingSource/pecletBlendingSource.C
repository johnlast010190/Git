...
#include "fieldBlendingFactor/blendingSources/pecletBlendingSource/pecletBlendingSource.H"
...
defineTypeNameAndDebug(pecletBlendingSource, 0);
addToRunTimeSelectionTable
(blendingSource, pecletBlendingSource, dictionary);

// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

pecletBlendingSource::pecletBlendingSource
(
...
tmp<surfaceScalarField> pecletBlendingSource::sourceField()
{
    typedef compressible::turbulenceModel cmpTurbModel;
    typedef incompressible::turbulenceModel icoTurbModel;

    tmp<surfaceScalarField> PeNum;
    ...
    else
    {
        FatalErrorInFunction
            ...
            << "a compressible or incompressible turbulence model. "
            << nl << exit(FatalError);
    }
