    ...
    pComfort_(nullptr)
{
    ...
    (
        ...
        (
            ...
            mesh_,
            dimensionedScalar(dimless, nThresh)
         )
    );
}
...
Foam::functionObjects::pedestrianComfort::~pedestrianComfort() = default;
...
bool Foam::functionObjects::pedestrianComfort::read(const dictionary& dict)
{
    ...
    windDirections_ = dict.lookup<List<word>>("windDirections");
    numberOfWindDirections_ = windDirections_.size();

    WeibullParameters_ = dict.lookup<List<Vector<scalar>>>("WeibullParameters");
    instanceNames_ = dict.lookup<List<word>>("instances");
    ...
    hRef_ = dict.lookup<List<scalar>>("referenceHeight");
    ...
    URef_ = dict.lookup<List<scalar>>("referenceVelocity");
    ...
    criteriaExceedance_ = dict.lookup<List<scalar>>("criteriaExceedance");
    criteriaThresholds_ = dict.lookup<List<scalar>>("criteriaThresholds");
