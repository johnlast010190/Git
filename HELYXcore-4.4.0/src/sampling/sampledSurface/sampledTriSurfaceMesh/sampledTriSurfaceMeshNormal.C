...
#include "sampledSurface/sampledTriSurfaceMesh/sampledTriSurfaceMeshNormal.H"
...
) const
{
    ...
    tmp<vectorField> tn(new vectorField(points().size(), vector::zero));
