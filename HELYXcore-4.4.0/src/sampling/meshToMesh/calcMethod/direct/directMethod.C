...
#include "meshToMesh/calcMethod/direct/directMethod.H"
...
)
{
    ...
    while (iterationI++ < 1000)
    {
        ...
        {
            // if meshes are collocated, after inflating the source
            // mesh bounding box tgt mesh cells may be transferred,
            // but may still not overlap with the source mesh
            return;
        }
    }
}
