...
#include "refinerOF/fvMeshTopoChangersRefinerOF.H"
...
{
    defineTypeNameAndDebug(refinerOF, 0);
    addToRunTimeSelectionTable(fvMeshTopoChanger, refinerOF, fvMesh);
}
}
...
Foam::label Foam::fvMeshTopoChangers::refinerOF::count
(
...
void Foam::fvMeshTopoChangers::refinerOF::calculateProtectedCells
(
...
void Foam::fvMeshTopoChangers::refinerOF::readDict()
{
...
Foam::fvMeshTopoChangers::refinerOF::refine
(
...
Foam::autoPtr<Foam::polyTopoChangeMap>
Foam::fvMeshTopoChangers::refinerOF::unrefine
(
...
Foam::word Foam::fvMeshTopoChangers::refinerOF::Uname
(
...
/*
void Foam::fvMeshTopoChangers::refinerOF::refineFluxesNew
(
...
void Foam::fvMeshTopoChangers::refinerOF::unrefineFluxesNew
(
...
*/
void Foam::fvMeshTopoChangers::refinerOF::refineFluxes
(
    const labelHashSet& masterFaces,
    const polyTopoChangeMap& map
)
...
void Foam::fvMeshTopoChangers::refinerOF::unrefineFluxes
(
    const Map<label>& faceToSplitPoint,
    const polyTopoChangeMap& map
)
...
void Foam::fvMeshTopoChangers::refinerOF::refineUfs
(
    const labelHashSet& masterFaces,
    const polyTopoChangeMap& map
)
...
void Foam::fvMeshTopoChangers::refinerOF::unrefineUfs
(
    const Map<label>& faceToSplitPoint,
    const polyTopoChangeMap& map
)
...
const Foam::cellZone& Foam::fvMeshTopoChangers::refinerOF::findCellZone
(
...
Foam::scalarField
Foam::fvMeshTopoChangers::refinerOF::cellToPoint(const scalarField& vFld) const
{
...
Foam::scalarField Foam::fvMeshTopoChangers::refinerOF::error
(
...
void Foam::fvMeshTopoChangers::refinerOF::selectRefineCandidates
(
...
Foam::scalar Foam::fvMeshTopoChangers::refinerOF::selectRefineCandidates
(
    PackedBoolList& candidateCells,
...
Foam::labelList Foam::fvMeshTopoChangers::refinerOF::selectRefineCells
(
...
Foam::labelList Foam::fvMeshTopoChangers::refinerOF::selectUnrefinePoints
(
...
void Foam::fvMeshTopoChangers::refinerOF::extendMarkedCells
(
...
void Foam::fvMeshTopoChangers::refinerOF::checkEightAnchorPoints
(
...
Foam::fvMeshTopoChangers::refinerOF::refinerOF(fvMesh& mesh, const dictionary& dict)
:
...
Foam::fvMeshTopoChangers::refinerOF::~refinerOF()
{}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

bool Foam::fvMeshTopoChangers::refinerOF::update()
{
...
void Foam::fvMeshTopoChangers::refinerOF::topoChange(const polyTopoChangeMap& map)
{
...
void Foam::fvMeshTopoChangers::refinerOF::mapMesh(const polyMeshMap& map)
{
...
void Foam::fvMeshTopoChangers::refinerOF::distribute
(
...
bool Foam::fvMeshTopoChangers::refinerOF::write(const bool write) const
{
