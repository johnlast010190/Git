...
#include "regionCoupling/derivedFvPatchFields/filmPyrolysisVelocityCoupled/filmPyrolysisVelocityCoupledFvPatchVectorField.H"
#include "db/runTimeSelection/construction/addToRunTimeSelectionTable.H"
#include "fields/surfaceFields/surfaceFields.H"
#include "pyrolysisModels/pyrolysisModel/pyrolysisModel.H"
#include "surfaceFilmModels/surfaceFilmRegionModel/surfaceFilmRegionModel.H"
...
void Foam::filmPyrolysisVelocityCoupledFvPatchVectorField::updateCoeffs()
{
    ...
    //- Remap from cells to patch
    vectorField tUFilm(filmModel.Us());
    vectorField UFilm
    (
        UIndirectList<vector>
        (
            tUFilm,
            filmModel.U().boundaryField()[filmPatchi].patch().faceCells()
        )
    );
    ...
    // Evaluate velocity
    Up = coverageFilm*UFilm + (1.0 - coverageFilm)*UAvePyr*nf;
