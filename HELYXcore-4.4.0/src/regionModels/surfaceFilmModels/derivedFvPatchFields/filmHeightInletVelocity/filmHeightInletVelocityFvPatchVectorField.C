...
#include "surfaceFilmModels/derivedFvPatchFields/filmHeightInletVelocity/filmHeightInletVelocityFvPatchVectorField.H"
...
void Foam::filmHeightInletVelocityFvPatchVectorField::updateCoeffs()
{
    ...
    forceAssign(n*phip/(rhop*magSf*deltafp + ROOTVSMALL));
