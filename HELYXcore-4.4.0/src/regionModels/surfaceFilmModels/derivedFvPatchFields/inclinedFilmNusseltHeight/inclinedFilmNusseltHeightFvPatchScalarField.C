...
#include "surfaceFilmModels/derivedFvPatchFields/inclinedFilmNusseltHeight/inclinedFilmNusseltHeightFvPatchScalarField.H"
...
void Foam::inclinedFilmNusseltHeightFvPatchScalarField::updateCoeffs()
{
    ...
    forceAssign
    (
        pow(3.0*sqr(mup/rhop)/(gTan + ROOTVSMALL), 1.0/3.0)*pow(Re, 1.0/3.0)
    );
