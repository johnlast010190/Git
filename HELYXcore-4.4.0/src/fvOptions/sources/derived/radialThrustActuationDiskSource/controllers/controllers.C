...
Foam::controllers::controllers(const fvMesh& mesh, const dictionary& dict)
:
    ...
    printControl_(false)
{
    if (dict.found("controller"))
    {
        ...
        {
            case fixed:
                P_ = controllerDict_.lookup<scalar>("P");
                I_ = controllerDict_.lookup<scalar>("I");
        ...
        startTime_ = controllerDict_.lookup<scalar>("startTime");
        printControl_ =
            controllerDict_.lookupOrDefault<bool>("printControl", false);
...
)
{
    switch (tuningMode_)
    {
        ...
        case nuutinen:
            const scalar T = controllerDict_.lookup<scalar>("estimatedThrust");
            const scalar n = controllerDict_.lookup<scalar>("estimatedRPS");
