    ...
    rAPtr_(nullptr)
{
    ...
    if (propsFile.good())
    {
        ...
        gradP0_ = propsDict.lookup<scalar>("gradient");
    }
...
void Foam::fv::meanVelocityForce::sourceFields(wordList& fieldNames)
{
...
void Foam::fv::meanVelocityForce::correct(volVectorField& U)
{
    ...
    if (!mesh_.foundObject<helyxCoupledControl>(solutionControl::typeName))
    {
