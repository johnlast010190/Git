...
void Foam::fv::directionalPressureGradientExplicitSource::init()
{
    ...
    cellFaceMap_(cells_.size(), -1)
{
    ...
    {
        D_ = coeffs_.lookup<scalar>("D");
        I_ = coeffs_.lookup<scalar>("I");
        length_ = coeffs_.lookup<scalar>("length");
    }
    else
    {
        FatalErrorInFunction
    ...
    if (propsFile.good())
    {
        ...
        gradP0_ = propsDict.lookup<vectorField>("gradient");
    }
...
void Foam::fv::directionalPressureGradientExplicitSource::sourceFields
(
    wordList& fieldNames
)
{
...
)
{
    ...
    switch (model_)
    {
        ...
        case pPressureDrop:
        {
            ...
            gradPporous_ = -flowDir_*pressureDrop_->value(t);
            break;
        }
        case pVolumetricFlowRate:
        {
            ...
            gradPporous_ = -flowDir_*pressureDrop_->value(volFlowRate);
            break;
        }
    }
