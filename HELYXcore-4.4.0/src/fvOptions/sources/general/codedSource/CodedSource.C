...
) const
{
    ...
    dynCode.setOptions
    (
        "-I$(HELYX_PROJECT_DIR)/src/finiteVolume \
        -I$(HELYX_PROJECT_DIR)/src/meshTools \
        -I$(HELYX_PROJECT_DIR)/src/sampling \
        -I$(HELYX_PROJECT_DIR)/src/fvOptions " + context.options()
    );
    dynCode.setLinkLibs
    (
